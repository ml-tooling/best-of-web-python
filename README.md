...
<details><summary><b><a href="https://github.com/django/django">django</a></b> (🥇40 ·  ⭐ 88K) - The Web framework for perfectionists with deadlines. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/django/django) (👨‍💻 3.5K · 🔀 34K · 📦 2M):
	...
	```
- [PyPi](https://pypi.org/project/django) (📥 56M / month · 📦 24K · ⏱️ 05.08.2026):
	```
	pip install django
	```
- [Conda](https://anaconda.org/conda-forge/django) (📥 4M · ⏱️ 06.08.2026):
	```
...
- [GitHub]() (👨‍💻 910 · 🔀 9.7K · 📦 920K):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 600M / month · 📦 35K · ⏱️ 29.07.2026):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 5.6M · ⏱️ 30.07.2026):
	```
	conda install -c conda-forge fastapi
	```
</details>
<details><summary><b><a href="https://github.com/pallets/flask">flask</a></b> (🥇38 ·  ⭐ 71K) - The Python micro framework for building web applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pallets/flask) (👨‍💻 860 · 🔀 17K · 📦 2.8M):
...
- [PyPi](https://pypi.org/project/flask) (📥 210M / month · 📦 19K · ⏱️ 19.02.2026):
	...
	pip install flask
	```
- [Conda](https://anaconda.org/conda-forge/flask) (📥 14M · ⏱️ 19.02.2026):
	```
...
- [GitHub](https://github.com/tornadoweb/tornado) (👨‍💻 480 · 🔀 5.6K · 📦 700K):

	```
	git clone https://github.com/tornadoweb/tornado
	```
- [PyPi](https://pypi.org/project/tornado) (📥 120M / month · 📦 4.2K · ⏱️ 07.08.2026):
	```
	pip install tornado
	```
- [Conda](https://anaconda.org/conda-forge/tornado) (📥 77M · ⏱️ 10.08.2026):
	```
...
- [GitHub]() (👨‍💻 340 · 🔀 1.3K · 📦 440K):

	```
	git clone https://github.com/encode/starlette
	```
- [PyPi](https://pypi.org/project/starlette) (📥 650M / month · 📦 7.6K · ⏱️ 08.08.2026):
	```
	pip install starlette
	```
- [Conda](https://anaconda.org/conda-forge/starlette) (📥 6.7M · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 510 · 🔀 1.8K · 📦 1.7M):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 270M / month · 📦 5.2K · ⏱️ 02.04.2026):
	```
...
- [GitHub](https://github.com/encode/django-rest-framework) (👨‍💻 1.5K · 🔀 7.1K · 📦 860K):

	```
	git clone https://github.com/encode/django-rest-framework
	```
- [PyPi](https://pypi.org/project/django-rest-framework) (📥 94K / month · 📦 110 · ⏱️ 20.07.2017):
	```
	pip install django-rest-framework
	```
- [Conda](https://anaconda.org/conda-forge/djangorestframework) (📥 1.6M · ⏱️ 08.08.2026):
	```
...
- [PyPi](https://pypi.org/project/sanic) (📥 1.7M / month · 📦 820 · ⏱️ 31.05.2026):
	...
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 790K · ⏱️ 03.06.2026):
	```
...
- [GitHub](https://github.com/bottlepy/bottle) (👨‍💻 240 · 🔀 1.5K · 📦 37K):
...
- [PyPi](https://pypi.org/project/bottle) (📥 11M / month · 📦 800 · ⏱️ 15.06.2025):
	...
	pip install bottle
	```
- [Conda](https://anaconda.org/conda-forge/bottle) (📥 700K · ⏱️ 11.08.2025):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 250 · 🔀 1K · 📦 11K):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 1.8M / month · 📦 430 · ⏱️ 16.06.2026):
	```
	pip install falcon
	```
- [Conda](https://anaconda.org/conda-forge/falcon) (📥 1.2M · ⏱️ 16.06.2026):
	```
...
- [GitHub](https://github.com/litestar-org/litestar) (👨‍💻 300 · 🔀 590 · 📦 2.4K):

	```
	git clone https://github.com/litestar-org/litestar
	```
- [PyPi](https://pypi.org/project/litestar) (📥 2.1M / month · 📦 280 · ⏱️ 11.06.2026):
	```
...
- [GitHub](https://github.com/cherrypy/cherrypy) (👨‍💻 150 · 🔀 370 · 📦 15K):
...
- [GitHub](https://github.com/dpgaspar/Flask-AppBuilder) (👨‍💻 230 · 🔀 1.4K):

	```
	git clone https://github.com/dpgaspar/Flask-AppBuilder
	```
- [PyPi](https://pypi.org/project/flask-appbuilder) (📥 14M / month · 📦 16 · ⏱️ 29.06.2026):
	```
	pip install flask-appbuilder
	```
- [Conda](https://anaconda.org/conda-forge/flask-appbuilder) (📥 820K · ⏱️ 25.06.2026):
	```
...
- [GitHub](https://github.com/django-tastypie/django-tastypie) (👨‍💻 200 · 🔀 1.2K · 📦 6.4K):
	...
	```
- [PyPi](https://pypi.org/project/django-tastypie) (📥 130K / month · 📦 48 · ⏱️ 23.02.2025):
	```
...
- [GitHub](https://github.com/pgjones/quart) (👨‍💻 68 · 🔀 200):
	...
	```
- [PyPi](https://pypi.org/project/quart) (📥 4M / month · 📦 310 · ⏱️ 23.07.2026):
	```
	pip install quart
	```
- [Conda](https://anaconda.org/conda-forge/quart) (📥 150K · ⏱️ 28.07.2026):
	```
	conda install -c conda-forge quart
	```
</details>
<details><summary><b><a href="https://github.com/pyeve/eve">eve</a></b> (🥉25 ·  ⭐ 6.7K) - REST API framework designed for human beings. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 220 · 🔀 730 · 📦 1.2K):
	...
	```
- [PyPi](https://pypi.org/project/eve) (📥 27K / month · 📦 46 · ⏱️ 24.03.2026):
	```
	pip install eve
	```
</details>
...
- [GitHub](https://github.com/webpy/webpy) (👨‍💻 98 · 🔀 1.3K · 📦 24):

	```
	git clone https://github.com/webpy/webpy
	```
- [PyPi](https://pypi.org/project/web.py) (📥 85K / month · 📦 53 · ⏱️ 09.11.2020):
	```
	pip install web.py
	```
- [Conda](https://anaconda.org/conda-forge/web.py) (📥 150K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge web.py
	```
</details>
<details><summary><b><a href="https://responder.kennethreitz.org">responder</a></b> (🥉23 ·  ⭐ 3.6K) - A familiar HTTP Service Framework for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub]() (👨‍💻 87 · 🔀 220 · 📦 600):
	...
	```
- [PyPi](https://pypi.org/project/responder) (📥 8.6K / month · 📦 15 · ⏱️ 14.07.2026):
	```
...
<details><summary><b><a href="https://github.com/MasoniteFramework/masonite">masonite</a></b> (🥉23 ·  ⭐ 2.4K) - The Modern And Developer Centric Python Web Framework. Be sure to read.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 89 · 🔀 140 · 📦 550):
	...
	```
- [PyPi](https://pypi.org/project/masonite) (📥 20K / month · 📦 53 · ⏱️ 07.06.2026):
	```
...
- [GitHub](https://github.com/plone/guillotina) (👨‍💻 54 · 🔀 53 · 📦 140):

	```
	git clone https://github.com/plone/guillotina
	```
- [PyPi](https://pypi.org/project/guillotina) (📥 1.6K / month · 📦 38 · ⏱️ 24.06.2026):
	```
...
- [GitHub](https://github.com/emmett-framework/emmett) (👨‍💻 25 · 🔀 73 · 📦 95):
	...
	```
- [PyPi](https://pypi.org/project/emmett) (📥 310 / month · 📦 8 · ⏱️ 07.04.2026):
	```
	pip install emmett
	```
</details>
...
- [GitHub]() (👨‍💻 11 · 🔀 17 · 📦 16):
	...
	```
- [PyPi](https://pypi.org/project/flama) (📥 4.1K / month · 📦 1 · ⏱️ 31.07.2026):
	```
	pip install flama
	```
</details>
...
<details><summary><b><a href="https://github.com/ZeroIntensity/view.py">view.py</a></b> (🥉10 ·  ⭐ 210) - The Batteries-Detachable Web Framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ZeroIntensity/view.py) (👨‍💻 13 · 🔀 16):
	...
	```
- [PyPi](https://pypi.org/project/view.py) (📥 110 / month · ⏱️ 26.05.2024):
	```
	pip install view.py
	```
</details>
...
- <b><a href="https://justpy.io/">justpy</a></b> (🥉15 ·  ⭐ 1.3K · 💀) - An object oriented high-level Python Web Framework that.. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 800 · 🔀 10K · 📦 4.3M):

	```
	git clone https://github.com/psf/requests
	```
- [PyPi](https://pypi.org/project/requests) (📥 1.8B / month · 📦 170K · ⏱️ 14.05.2026):
	```
	pip install requests
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 91M · ⏱️ 15.05.2026):
	```
	conda install -c conda-forge requests
	```
</details>
<details><summary><b><a href="https://github.com/urllib3/urllib3">urllib3</a></b> (🥇38 ·  ⭐ 4K) - urllib3 is a user-friendly HTTP client library for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 400 · 🔀 1.5K · 📦 2.5M):

	```
	git clone https://github.com/urllib3/urllib3
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 1.9B / month · 📦 25K · ⏱️ 07.05.2026):
	```
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 99M · ⏱️ 07.05.2026):
	```
	conda install -c conda-forge urllib3
	```
</details>
<details><summary><b><a href="https://github.com/aio-libs/aiohttp">aiohttp</a></b> (🥈35 ·  ⭐ 17K) - Asynchronous HTTP client/server framework for asyncio and Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aio-libs/aiohttp) (👨‍💻 990 · 🔀 2.4K):

	```
	git clone https://github.com/aio-libs/aiohttp
	```
- [PyPi](https://pypi.org/project/aiohttp) (📥 650M / month · 📦 33K · ⏱️ 23.07.2026):
	```
	pip install aiohttp
	```
- [Conda](https://anaconda.org/conda-forge/aiohttp) (📥 30M · ⏱️ 24.07.2026):
	```
	conda install -c conda-forge aiohttp
	```
</details>
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈34 ·  ⭐ 15K · 💤) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 250 · 🔀 960 · 📦 670K):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 840M / month · 📦 22K · ⏱️ 15.09.2025):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 22M · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/MagicStack/httptools) (👨‍💻 24 · 🔀 100 · 📦 200K):

	```
	git clone https://github.com/MagicStack/httptools
	```
- [PyPi](https://pypi.org/project/httptools) (📥 270M / month · 📦 590 · ⏱️ 25.05.2026):
	```
	pip install httptools
	```
- [Conda](https://anaconda.org/conda-forge/httptools) (📥 4.6M · ⏱️ 26.05.2026):
	```
...
- [GitHub](https://github.com/encode/httpcore) (👨‍💻 59 · 🔀 170 · 📦 440K):

	```
	git clone https://github.com/encode/httpcore
	```
- [PyPi](https://pypi.org/project/httpcore) (📥 820M / month · 📦 970 · ⏱️ 24.04.2025):
	```
	pip install httpcore
	```
- [Conda](https://anaconda.org/conda-forge/httpcore) (📥 23M · ⏱️ 25.04.2025):
	```
...
- [GitHub](https://github.com/mvantellingen/python-zeep) (👨‍💻 150 · 🔀 610):
	...
	```
- [PyPi](https://pypi.org/project/zeep) (📥 42M / month · 📦 750 · ⏱️ 18.06.2026):
	```
	pip install zeep
	```
...
<details><summary><b><a href="https://github.com/twisted/treq">treq</a></b> (🥉22 ·  ⭐ 600) - Python requests like API built on top of Twisteds HTTP client. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/twisted/treq) (👨‍💻 58 · 🔀 140):

	```
	git clone https://github.com/twisted/treq
	```
- [PyPi](https://pypi.org/project/treq) (📥 280K / month · 📦 130 · ⏱️ 02.07.2026):
	```
	pip install treq
	```
- [Conda](https://anaconda.org/conda-forge/treq) (📥 320K · ⏱️ 02.07.2026):
	```
	conda install -c conda-forge treq
	```
</details>
<details><summary><b><a href="https://github.com/reorx/httpstat">httpstat</a></b> (🥉19 ·  ⭐ 6.3K) - curl statistics made simple. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/reorx/httpstat) (👨‍💻 6 · 🔀 380 · 📦 20):
	...
	```
- [PyPi](https://pypi.org/project/httpstat) (📥 1.5K / month · ⏱️ 08.04.2026):
	```
...
- <b><a href="https://github.com/requests/toolbelt">requests-toolbelt</a></b> (🥈30 ·  ⭐ 1K · 💀) - A toolbelt of useful classes and functions to be used.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://github.com/pycurl/pycurl">pycurl</a></b> (🥉29 ·  ⭐ 1.2K) - PycURL - Python interface to libcurl. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code>
- <b><a href="https://github.com/ross/requests-futures">requests-futures</a></b> (🥉27 ·  ⭐ 2.1K · 💀) - Asynchronous Python HTTP Requests for Humans using.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://httpie.io/">httpie</a></b> (🥉25 ·  ⭐ 37K · 💀) - HTTPie: modern, user-friendly command-line HTTP client for the API era. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/spyoungtech/grequests">grequests</a></b> (🥉25 ·  ⭐ 4.5K · 💀) - Requests + Gevent = 3. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code>
- <b><a href="https://github.com/python-hyper/hyper">hyper</a></b> (🥉23 ·  ⭐ 1K · 💀) - HTTP/2 for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/httpie/http-prompt">http-prompt</a></b> (🥉20 ·  ⭐ 8.9K · 💀) - An interactive command-line HTTP and API testing client built on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/benoitc/http-parser">http-parser</a></b> (🥉20 ·  ⭐ 340 · 💀) - HTTP request/response parser for python in C. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
<br>
...
- [GitHub]() (👨‍💻 220 · 🔀 1K · 📦 910K):
	...
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 640M / month · 📦 23K · ⏱️ 13.08.2026):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 7.8M · ⏱️ 01.08.2026):
	```
...
- [GitHub](https://github.com/django/asgiref) (👨‍💻 120 · 🔀 250 · 📦 1.1M):
...
- [PyPi](https://pypi.org/project/asgiref) (📥 150M / month · 📦 1.4K · ⏱️ 14.07.2026):
	...
	pip install asgiref
	```
- [Conda](https://anaconda.org/conda-forge/asgiref) (📥 2.4M · ⏱️ 05.02.2026):
	```
...
- [GitHub](https://github.com/gevent/gevent) (👨‍💻 130 · 🔀 960 · 📦 150K):

	```
	git clone https://github.com/gevent/gevent
	```
- [PyPi](https://pypi.org/project/gevent) (📥 50M / month · 📦 2.4K · ⏱️ 10.08.2026):
	```
	pip install gevent
	```
- [Conda](https://anaconda.org/conda-forge/gevent) (📥 2.5M · ⏱️ 11.08.2026):
	```
	conda install -c conda-forge gevent
	```
</details>
<details><summary><b><a href="https://github.com/evansd/whitenoise">whitenoise</a></b> (🥈30 ·  ⭐ 2.7K) - Radically simplified static file serving for Python web apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/evansd/whitenoise) (👨‍💻 70 · 🔀 150 · 📦 530K):

	```
	git clone https://github.com/evansd/whitenoise
	```
- [PyPi](https://pypi.org/project/whitenoise) (📥 17M / month · 📦 580 · ⏱️ 27.02.2026):
	```
	pip install whitenoise
	```
- [Conda](https://anaconda.org/conda-forge/whitenoise) (📥 290K · ⏱️ 27.02.2026):
	```
	conda install -c conda-forge whitenoise
	```
</details>
<details><summary><b><a href="https://github.com/Kludex/mangum">mangum</a></b> (🥉24 ·  ⭐ 2.1K) - AWS Lambda support for ASGI applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://fastapi.tiangolo.com/img/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub]() (👨‍💻 35 · 🔀 130 · 📦 8.7K):
	...
	```
- [PyPi](https://pypi.org/project/mangum) (📥 6.6M / month · 📦 120 · ⏱️ 01.02.2026):
	```
	pip install mangum
	```
</details>
<details><summary><b><a href="https://github.com/jonashaag/bjoern">bjoern</a></b> (🥉23 ·  ⭐ 3K · 💤) - A screamingly fast Python 2/3 WSGI server written in C. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 190 · 📦 850):

	```
	git clone https://github.com/jonashaag/bjoern
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 53K / month · 📦 67 · ⏱️ 19.09.2022):
	```
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 290K · ⏱️ 29.08.2025):
	```
...
- [GitHub](https://github.com/lepture/python-livereload) (👨‍💻 62 · 🔀 150):
...
- [PyPi](https://pypi.org/project/livereload) (📥 650K / month · 📦 350 · ⏱️ 18.12.2024):
	...
	```
- [Conda](https://anaconda.org/conda-forge/livereload) (📥 940K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge livereload
	```
</details>
<details><summary><b><a href="https://github.com/pgjones/hypercorn">Hypercorn</a></b> (🥉19 ·  ⭐ 1.6K · 💤) - Hypercorn is an ASGI Server based on Hyper libraries and inspired.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pgjones/hypercorn) (👨‍💻 73 · 🔀 140 · 📦 13K):
	...
	```
- [PyPi](https://pypi.org/project/hypercorn) (📦 160 · ⏱️ 08.11.2025):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 160 · 🔀 760 · 📦 830K):
	...
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 710M / month · 📦 9K · ⏱️ 21.05.2026):
	```
	pip install pyjwt
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 810 · 🔀 3.1K · 📦 270K):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 5M / month · 📦 320 · ⏱️ 13.08.2026):
	```
	pip install django-allauth
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 420K · ⏱️ 13.08.2026):
	```
	conda install -c conda-forge django-allauth
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-auth-library-python">google-auth</a></b> (🥇33 ·  ⭐ 5.4K) - This library has moved to https://github.com/googleapis/google-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-auth-library-python) (👨‍💻 170 · 🔀 1.8K):

	```
	git clone https://github.com/googleapis/google-auth-library-python
	```
- [PyPi](https://pypi.org/project/google-auth) (📥 590M / month · 📦 5K · ⏱️ 06.08.2026):
	```
	pip install google-auth
	```
- [Conda](https://anaconda.org/conda-forge/google-auth) (📥 16M · ⏱️ 06.08.2026):
	```
	conda install -c conda-forge google-auth
	```
</details>
<details><summary><b><a href="https://github.com/oauthlib/oauthlib">oauthlib</a></b> (🥇33 ·  ⭐ 2.9K · 💤) - A generic, spec-compliant, thorough implementation of the OAuth.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 200 · 🔀 500 · 📦 650K):
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 340M / month · 📦 1.7K · ⏱️ 19.06.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 18M · ⏱️ 20.06.2025):
	```
...
- [GitHub](https://github.com/pyauth/pyotp) (👨‍💻 53 · 🔀 350 · 📦 28K):
...
<details><summary><b><a href="https://authlib.org">authlib</a></b> (🥈29 ·  ⭐ 5.4K) - The ultimate Python library in building OAuth and OpenID Connect.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/authlib) (📥 150M / month · 📦 1.6K · ⏱️ 06.05.2026):
	...
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 370K · ⏱️ 19.05.2026):
	```
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 190 · 🔀 590 · 📦 7.8K):

	```
	git clone https://github.com/django-guardian/django-guardian
	```
- [PyPi](https://pypi.org/project/django-guardian) (📥 1M / month · 📦 120 · ⏱️ 22.07.2026):
	```
	pip install django-guardian
	```
- [Conda](https://anaconda.org/conda-forge/django-guardian) (📥 170K · ⏱️ 23.07.2026):
	```
...
- [PyPi](https://pypi.org/project/dj-rest-auth) (📥 790K / month · 📦 26 · ⏱️ 15.03.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dj-rest-auth) (📥 64K · ⏱️ 16.03.2026):
	```
...
- [GitHub](https://github.com/vimalloc/flask-jwt-extended) (👨‍💻 100 · 🔀 250 · 📦 67K):
...
- [GitHub](https://github.com/sunscrapers/djoser) (👨‍💻 110 · 🔀 470 · 📦 36K):

	```
	git clone https://github.com/sunscrapers/djoser
	```
- [PyPi](https://pypi.org/project/djoser) (📥 380K / month · 📦 14 · ⏱️ 01.08.2026):
	```
	pip install djoser
	```
</details>
...
- [GitHub](https://github.com/mpdavis/python-jose) (👨‍💻 62 · 🔀 260):

	```
	git clone https://github.com/mpdavis/python-jose
	```
- [PyPi](https://pypi.org/project/python-jose) (📥 45M / month · 📦 1.1K · ⏱️ 28.05.2025):
	```
	pip install python-jose
	```
- [Conda](https://anaconda.org/conda-forge/python-jose) (📥 2.7M · ⏱️ 29.05.2025):
	```
...
- [GitHub](https://github.com/jazzband/djangorestframework-simplejwt) (👨‍💻 140 · 🔀 710):

	```
	git clone https://github.com/jazzband/djangorestframework-simplejwt
	```
- [PyPi](https://pypi.org/project/djangorestframework-simplejwt) (📥 8.1M / month · 📦 310 · ⏱️ 21.07.2025):
	```
...
- [GitHub]() (👨‍💻 64 · 🔀 230 · 📦 12K):
	...
	```
- [PyPi](https://pypi.org/project/django-rest-knox) (📥 810K / month · 📦 46 · ⏱️ 12.07.2026):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 34 · 🔀 150):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/rules) (📥 570K / month · 📦 56 · ⏱️ 02.09.2024):
	```
	pip install rules
	```
</details>
...
- [GitHub](https://github.com/django-cas-ng/django-cas-ng) (👨‍💻 92 · 🔀 170 · 📦 660):

	```
	git clone https://github.com/django-cas-ng/django-cas-ng
	```
- [PyPi](https://pypi.org/project/django-cas-ng) (📥 59K / month · 📦 15 · ⏱️ 05.05.2026):
	```
...
- [GitHub](https://github.com/dusktreader/flask-praetorian) (👨‍💻 27 · 🔀 47 · 📦 460):
...
- [GitHub](https://github.com/authomatic/authomatic) (👨‍💻 49 · 🔀 390):
...
<details><summary><b><a href="https://flask-simple-login.readthedocs.io">flask_simplelogin</a></b> (🥉17 ·  ⭐ 200) - Flask Simple Login - Login Extension for Flask. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub]() (👨‍💻 12 · 🔀 43 · 📦 140):
	...
	```
- [PyPi](https://pypi.org/project/flask_simplelogin) (📥 24K / month · 📦 4 · ⏱️ 04.05.2026):
	```
...
- <b><a href="https://github.com/requests/requests-oauthlib">requests-oauthlib</a></b> (🥈32 ·  ⭐ 1.8K · 💀) - OAuthlib support for Python-Requests!. <code><a href="http://bit.ly/3hkKRql">ISC</a></code>
- <b><a href="https://github.com/maxcountryman/flask-login">flask-login</a></b> (🥈30 ·  ⭐ 3.6K · 💀) - Flask user session management. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/omab/python-social-auth">python-social-auth</a></b> (🥈27 ·  ⭐ 2.8K · 💀) - Social auth made simple. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/googleapis/oauth2client">oauth2client</a></b> (🥉26 ·  ⭐ 800 · 💀) - This is a Python library for accessing resources protected.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/wichert/pyramid_jwt">pyramid_jwt</a></b> (🥉13 ·  ⭐ 75 · 💀) - JWT authentication for Pyramid. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://trypyramid.com/img/pyramid-16x16.png" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/lxml/lxml">lxml</a></b> (🥇35 ·  ⭐ 3K) - The lxml XML toolkit for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lxml/lxml) (👨‍💻 180 · 🔀 620 · 📦 620K):
...
<details><summary><b><a href="https://github.com/Kozea/WeasyPrint">WeasyPrint</a></b> (🥈32 ·  ⭐ 9.2K) - The awesome document factory. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Kozea/WeasyPrint) (👨‍💻 190 · 🔀 820 · 📦 31K):

	```
	git clone https://github.com/Kozea/WeasyPrint
	```
- [PyPi](https://pypi.org/project/weasyprint) (📥 38M / month · 📦 1.1K · ⏱️ 02.06.2026):
	```
	pip install weasyprint
	```
- [Conda](https://anaconda.org/conda-forge/weasyprint) (📥 450K · ⏱️ 09.06.2026):
	```
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 51 · 🔀 180 · 📦 2.2M):
	...
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 830M / month · 📦 5.3K · ⏱️ 27.09.2025):
	```
	pip install markupsafe
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 83M · ⏱️ 02.03.2026):
	```
	conda install -c conda-forge markupsafe
	```
</details>
<details><summary><b><a href="https://github.com/xhtml2pdf/xhtml2pdf">xhtml2pdf</a></b> (🥈30 ·  ⭐ 2.4K) - A library for converting HTML into PDFs using ReportLab. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/xhtml2pdf/xhtml2pdf) (👨‍💻 170 · 🔀 650 · 📦 21K):

	```
	git clone https://github.com/xhtml2pdf/xhtml2pdf
	```
- [PyPi](https://pypi.org/project/xhtml2pdf) (📥 4.2M / month · 📦 140 · ⏱️ 23.02.2025):
	```
	pip install xhtml2pdf
	```
- [Conda](https://anaconda.org/conda-forge/xhtml2pdf) (📥 260K · ⏱️ 01.07.2026):
	```
	conda install -c conda-forge xhtml2pdf
	```
</details>
<details><summary><b><a href="https://github.com/mozilla/bleach">bleach</a></b> (🥉29 ·  ⭐ 2.8K) - Bleach is an allowed-list-based HTML sanitizing library that escapes.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 79 · 🔀 260):
...
- [PyPi](https://pypi.org/project/bleach) (📥 77M / month · 📦 2.1K · ⏱️ 05.06.2026):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 29M · ⏱️ 05.06.2026):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 54 · 🔀 180 · 📦 28K):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 2.1M / month · 📦 600 · ⏱️ 27.07.2026):
	```
	pip install pyquery
	```
...
- [GitHub](https://github.com/rushter/selectolax) (👨‍💻 26 · 🔀 91 · 📦 3.4K):

	```
	git clone https://github.com/rushter/selectolax
	```
- [PyPi](https://pypi.org/project/selectolax) (📥 6M / month · 📦 470 · ⏱️ 15.07.2026):
	```
	pip install selectolax
	```
</details>
<details><summary><b><a href="https://github.com/kovidgoyal/html5-parser">html5-parser</a></b> (🥉20 ·  ⭐ 700 · 💤) - Fast C based HTML 5 parsing for python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kovidgoyal/html5-parser) (👨‍💻 7 · 🔀 40 · 📦 910):
...
- [GitHub](https://github.com/john-kurkowski/tldextract) (👨‍💻 56 · 🔀 220 · 📦 45K):
	...
	```
- [PyPi](https://pypi.org/project/tldextract) (📥 38M / month · 📦 1.1K · ⏱️ 08.08.2026):
	```
	pip install tldextract
	```
- [Conda](https://anaconda.org/conda-forge/tldextract) (📥 910K · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/aio-libs/yarl) (👨‍💻 140 · 🔀 200):
	...
	```
- [PyPi](https://pypi.org/project/yarl) (📥 640M / month · 📦 3.5K · ⏱️ 20.07.2026):
	```
	pip install yarl
	```
- [Conda](https://anaconda.org/conda-forge/yarl) (📥 29M · ⏱️ 20.07.2026):
	```
	conda install -c conda-forge yarl
	```
</details>
<details><summary><b><a href="https://github.com/python-hyper/uritemplate">uritemplate</a></b> (🥉26 ·  ⭐ 250) - URI template parsing per RFC6570. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/uritemplate) (📥 180M / month · 📦 570 · ⏱️ 02.06.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/uritemplate) (📥 8.2M · ⏱️ 02.06.2025):
	```
...
- <b><a href="https://github.com/skorokithakis/shortuuid">shortuuid</a></b> (🥈27 ·  ⭐ 2K · 💀) - A generator library for concise, unambiguous and URL-safe UUIDs. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/gruns/furl">furl</a></b> (🥉24 ·  ⭐ 2.7K · 💀) - URL parsing and manipulation made easy. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code>
...
🔗&nbsp;<b><a href="https://github.com/OAI/OpenAPI-Specification">OpenAPI-Specification</a></b> ( ⭐ 29K · 💀)  - The OpenAPI Specification Repository. <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/OpenAPITools/openapi-generator) (👨‍💻 3.9K · 🔀 7.6K · 📦 5):
	...
	```
- [PyPi](https://pypi.org/project/openapi-generator-cli) (📥 710K / month · 📦 25 · ⏱️ 21.07.2026):
	```
	pip install openapi-generator-cli
	```
- [npm](https://www.npmjs.com/package/@openapitools/openapi-generator-cli) (📥 6M / month · 📦 1.5K · ⏱️ 24.07.2026):
	```
...
- [GitHub](https://github.com/tfranzel/drf-spectacular) (👨‍💻 140 · 🔀 320 · 📦 140K):
	...
	```
- [PyPi](https://pypi.org/project/drf-spectacular) (📥 14M / month · 📦 420 · ⏱️ 06.07.2026):
	```
	pip install drf-spectacular
	```
- [Conda](https://anaconda.org/conda-forge/drf-spectacular) (📥 98K · ⏱️ 06.07.2026):
	```
	conda install -c conda-forge drf-spectacular
	```
</details>
<details><summary><b><a href="https://github.com/koxudaxi/datamodel-code-generator">datamodel-code-generator</a></b> (🥇30 ·  ⭐ 4K) - Generate Pydantic v2 models, dataclasses, TypedDict,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/koxudaxi/datamodel-code-generator) (👨‍💻 240 · 🔀 450 · 📦 3.9K):

	```
	git clone https://github.com/koxudaxi/datamodel-code-generator
	```
- [PyPi](https://pypi.org/project/datamodel-code-generator) (📥 18M / month · 📦 630 · ⏱️ 12.08.2026):
	```
	pip install datamodel-code-generator
	```
</details>
<details><summary><b><a href="https://github.com/marshmallow-code/apispec">apispec</a></b> (🥈29 ·  ⭐ 1.2K) - A pluggable API specification generator. Currently supports the.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/marshmallow-code/apispec) (👨‍💻 97 · 🔀 190 · 📦 20K):
	...
	```
- [PyPi](https://pypi.org/project/apispec) (📥 14M / month · 📦 390 · ⏱️ 06.03.2026):
	```
	pip install apispec
	```
- [Conda](https://anaconda.org/conda-forge/apispec) (📥 2M · ⏱️ 07.03.2026):
	```
	conda install -c conda-forge apispec
	```
</details>
<details><summary><b><a href="https://connexion.readthedocs.io/en/latest/">connexion</a></b> (🥈28 ·  ⭐ 4.6K · 💤) - Connexion - API first applications with OpenAPI/Swagger. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/openapi-generators/openapi-python-client) (👨‍💻 120 · 🔀 280 · 📦 1.6K):
	...
	```
- [PyPi](https://pypi.org/project/openapi-python-client) (📥 3.4M / month · 📦 150 · ⏱️ 30.05.2026):
	```
	pip install openapi-python-client
	```
- [Conda](https://anaconda.org/conda-forge/openapi-python-client) (📥 110K · ⏱️ 10.08.2026):
	```
	conda install -c conda-forge openapi-python-client
	```
</details>
<details><summary><b><a href="https://github.com/python-openapi/openapi-spec-validator">OpenAPI Spec validator</a></b> (🥈26 ·  ⭐ 410) - OpenAPI 2.0 (aka Swagger) and OpenAPI 3 spec validator. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/swagger-api/swagger-ui) (👨‍💻 630 · 🔀 9.3K · 📦 38K):

	```
	git clone https://github.com/swagger-api/swagger-ui
	```
</details>
<details><summary><b><a href="https://github.com/python-openapi/openapi-core">openapi-core</a></b> (🥉24 ·  ⭐ 370) - client-side and server-side support for the OpenAPI Specification.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub]() (👨‍💻 73 · 🔀 140 · 📦 2.6K):
	...
	```
- [PyPi](https://pypi.org/project/openapi-core) (📥 4M / month · 📦 130 · ⏱️ 02.04.2026):
	```
	pip install openapi-core
	```
- [Conda](https://anaconda.org/conda-forge/openapi-core) (📥 74K · ⏱️ 03.04.2026):
	```
...
- [GitHub](https://github.com/Redocly/redoc) (👨‍💻 230 · 🔀 2.4K · 📦 14K):

	```
	git clone https://github.com/Redocly/redoc
	```
</details>
<details><summary><b><a href="https://github.com/encode/apistar">apistar</a></b> (🥉22 ·  ⭐ 5.6K · 💤) - The Web API toolkit. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 410 · 📦 790):

	```
	git clone https://github.com/encode/apistar
	```
- [PyPi](https://pypi.org/project/apistar) (📥 9.3K / month · 📦 55 · ⏱️ 30.11.2023):
	```
	pip install apistar
	```
- [Conda](https://anaconda.org/conda-forge/apistar) (📥 180K · ⏱️ 07.01.2026):
	```
...
- [GitHub](https://github.com/Pylons/pyramid_openapi3) (👨‍💻 29 · 🔀 47 · 📦 140):
...
<details><summary><b><a href="https://github.com/0b01001001/spectree">Spectree</a></b> (🥉20 ·  ⭐ 360) - API spec validator and OpenAPI document generator for Python.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/0b01001001/spectree) (👨‍💻 50 · 🔀 85 · 📦 140):
...
- [GitHub](https://github.com/swagger-api/swagger-codegen) (👨‍💻 1.2K · 🔀 6K · 📦 26):

	```
	git clone https://github.com/swagger-api/swagger-codegen
	```
</details>
<details><summary><b><a href="https://github.com/Azure/autorest">AutoRest</a></b> (🥉18 ·  ⭐ 4.8K) - OpenAPI (f.k.a Swagger) Specification code generator. Supports C#,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Azure/autorest) (👨‍💻 180 · 🔀 740 · 📦 1K):
...
- <b><a href="https://sourcey.com/spectacle">Spectacle</a></b> (🥉16 ·  ⭐ 1.3K · 💀) - Generate beautiful static API documentation from.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/graphql-python/graphene) (👨‍💻 210 · 🔀 820 · 📦 32K):
	...
	```
- [PyPi](https://pypi.org/project/graphene) (📥 41M / month · 📦 320 · ⏱️ 09.11.2024):
	```
	pip install graphene
	```
- [Conda](https://anaconda.org/conda-forge/graphene) (📥 1.6M · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/strawberry-graphql/strawberry) (👨‍💻 360 · 🔀 660 · 📦 6K):

	```
	git clone https://github.com/strawberry-graphql/strawberry
	```
- [PyPi](https://pypi.org/project/strawberry-graphql) (📥 7.7M / month · 📦 270 · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/graphql-python/graphql-core) (👨‍💻 45 · 🔀 150 · 📦 43K):

	```
	git clone https://github.com/graphql-python/graphql-core
	```
- [PyPi](https://pypi.org/project/graphql-core) (📥 82M / month · 📦 630 · ⏱️ 19.06.2026):
	```
	pip install graphql-core
	```
- [Conda](https://anaconda.org/conda-forge/graphql-core) (📥 2.8M · ⏱️ 05.06.2026):
	```
	conda install -c conda-forge graphql-core
	```
</details>
<details><summary><b><a href="https://github.com/graphql-python/graphene-django">graphene-django</a></b> (🥈28 ·  ⭐ 4.4K) - Build powerful, efficient, and flexible GraphQL APIs.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code> <code><img src="https://graphql.org/img/logo.svg" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/graphql-python/graphene-django) (👨‍💻 220 · 🔀 760 · 📦 16K):
...
- [PyPi](https://pypi.org/project/graphene-django) (📥 1.2M / month · 📦 220 · ⏱️ 13.03.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/graphene-django) (📥 67K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/mirumee/ariadne) (👨‍💻 88 · 🔀 200 · 📦 2.1K):
	...
	```
- [PyPi](https://pypi.org/project/ariadne) (📥 1.9M / month · 📦 100 · ⏱️ 15.06.2026):
	```
	pip install ariadne
	```
</details>
<details><summary><b><a href="https://github.com/graphql-python/graphene-mongo">graphene-mongo</a></b> (🥉20 ·  ⭐ 290) - Graphene MongoEngine integration. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://graphql.org/img/logo.svg" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/graphql-python/graphene-mongo) (👨‍💻 38 · 🔀 110 · 📦 380):
...
<details><summary><b><a href="https://github.com/graphql-python/graphene-pydantic">graphene-pydantic</a></b> (🥉19 ·  ⭐ 250) - Integrate GraphQL with your Pydantic models. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://graphql.org/img/logo.svg" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/graphql-python/graphene-pydantic) (👨‍💻 25 · 🔀 47):

	```
	git clone https://github.com/graphql-python/graphene-pydantic
	```
- [PyPi](https://pypi.org/project/graphene-pydantic) (📥 480K / month · 📦 3 · ⏱️ 01.02.2024):
	```
...
- <b><a href="https://github.com/tartiflette/tartiflette">tartiflette</a></b> (🥉18 ·  ⭐ 860 · 💀) - GraphQL Engine built with Python 3.6+ / asyncio. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/NovemberOscar/Flask-GraphQL-Auth">Flask-GraphQL-Auth</a></b> (🥉14 ·  ⭐ 63 · 💀) - JWT library for Flask-GraphQL. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub]() (👨‍💻 89 · 🔀 600 · 📦 400K):
	...
	```
- [PyPi](https://pypi.org/project/websockets) (📥 580M / month · 📦 13K · ⏱️ 31.07.2026):
	```
	pip install websockets
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 8.3M · ⏱️ 02.08.2026):
	```
	conda install -c conda-forge websockets
	```
</details>
<details><summary><b><a href="https://github.com/websocket-client/websocket-client">websocket-client</a></b> (🥇32 ·  ⭐ 3.7K · 💤) - WebSocket client for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/websocket-client/websocket-client) (👨‍💻 230 · 🔀 780 · 📦 330K):
...
- [GitHub](https://github.com/miguelgrinberg/python-socketio) (👨‍💻 86 · 🔀 620 · 📦 71K):
	...
	```
- [PyPi](https://pypi.org/project/python-socketio) (📥 29M / month · 📦 1.2K · ⏱️ 06.08.2026):
	```
	pip install python-socketio
	```
- [Conda](https://anaconda.org/conda-forge/python-socketio) (📥 1.2M · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 79 · 🔀 290 · 📦 40K):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 6.2M / month · 📦 210 · ⏱️ 21.07.2026):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 230K · ⏱️ 21.07.2026):
	```
	conda install -c conda-forge daphne
	```
</details>
<details><summary><b><a href="https://github.com/miguelgrinberg/Flask-SocketIO">Flask-SocketIO</a></b> (🥉25 ·  ⭐ 5.5K · 📉) - Socket.IO integration for Flask applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/miguelgrinberg/Flask-SocketIO) (👨‍💻 72 · 🔀 900):
...
- [PyPi](https://pypi.org/project/flask-socketio) (📥 4.3M / month · 📦 760 · ⏱️ 21.02.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-socketio) (📥 800K · ⏱️ 21.02.2026):
	```
	conda install -c conda-forge flask-socketio
	```
</details>
<details><summary><b><a href="https://github.com/frankie567/httpx-ws">httpx-ws</a></b> (🥉23 ·  ⭐ 150) - WebSocket support for HTTPX. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/frankie567/httpx-ws) (👨‍💻 18 · 🔀 29 · 📦 1.5K):

	```
	git clone https://github.com/frankie567/httpx-ws
	```
- [PyPi](https://pypi.org/project/httpx-ws) (📥 12M / month · 📦 110 · ⏱️ 28.03.2026):
	```
	pip install httpx-ws
	```
- [Conda](https://anaconda.org/conda-forge/httpx-ws) (📥 59K · ⏱️ 28.03.2026):
	```
	conda install -c conda-forge httpx-ws
	```
</details>
<details><summary><b><a href="https://github.com/novnc/websockify">websockify</a></b> (🥉21 ·  ⭐ 4.4K) - Websockify is a WebSocket to TCP proxy/bridge. This allows a.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/novnc/websockify) (👨‍💻 100 · 🔀 830 · 📦 45):

	```
	git clone https://github.com/novnc/websockify
	```
- [PyPi](https://pypi.org/project/websockify) (📥 310K / month · 📦 22 · ⏱️ 26.05.2025):
	```
...
- [GitHub](https://github.com/grpc/grpc) (👨‍💻 1.2K · 🔀 11K · 📦 7.3K):
	...
	```
- [PyPi](https://pypi.org/project/grpcio) (📥 450M / month · 📦 6.8K · ⏱️ 23.07.2026):
	```
	pip install grpcio
	```
- [Conda](https://anaconda.org/conda-forge/grpcio) (📥 25M · ⏱️ 31.07.2026):
	```
	conda install -c conda-forge grpcio
	```
</details>
<details><summary><b><a href="https://github.com/tomerfiliba-org/rpyc">rpyc</a></b> (🥈25 ·  ⭐ 1.7K · 💤) - RPyC (Remote Python Call) - A transparent and symmetric RPC library for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tomerfiliba-org/rpyc) (👨‍💻 86 · 🔀 250 · 📦 3.4K):
...
<details><summary><b><a href="https://github.com/smagafurov/fastapi-jsonrpc">fastapi-jsonrpc</a></b> (🥉19 ·  ⭐ 420) - JSON-RPC server based on fastapi. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://fastapi.tiangolo.com/img/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/smagafurov/fastapi-jsonrpc) (👨‍💻 17 · 🔀 37 · 📦 83):

	```
	git clone https://github.com/smagafurov/fastapi-jsonrpc
	```
- [PyPi](https://pypi.org/project/fastapi-jsonrpc) (📥 34K / month · 📦 10 · ⏱️ 17.04.2026):
	```
...
- [GitHub](https://github.com/unum-cloud/ucall) (👨‍💻 14 · 🔀 54 · 📦 63):
	...
	```
- [PyPi](https://pypi.org/project/ucall) (📥 870 / month · 📦 1 · ⏱️ 15.04.2024):
	```
	pip install ucall
	```
</details>
...
- [GitHub](https://github.com/aws/chalice) (👨‍💻 210 · 🔀 1K · 📦 3.3K):

	```
	git clone https://github.com/aws/chalice
	```
- [PyPi](https://pypi.org/project/chalice) (📥 860K / month · 📦 70 · ⏱️ 07.05.2026):
	```
	pip install chalice
	```
- [Conda](https://anaconda.org/conda-forge/chalice) (📥 630K · ⏱️ 07.05.2026):
	```
	conda install -c conda-forge chalice
	```
</details>
<details><summary><b><a href="https://github.com/Miserlou/Zappa">Zappa</a></b> (🥈26 ·  ⭐ 12K) - Serverless Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/zappa) (📥 250K / month · 📦 20 · ⏱️ 11.03.2026):
	```
	pip install zappa
	```
</details>
...
- [GitHub](https://github.com/wagtail/wagtail) (👨‍💻 1.1K · 🔀 4.6K · 📦 12K):

	```
	git clone https://github.com/wagtail/wagtail
	```
- [PyPi](https://pypi.org/project/wagtail) (📥 1.1M / month · 📦 910 · ⏱️ 15.06.2026):
	```
	pip install wagtail
	```
- [Conda](https://anaconda.org/conda-forge/wagtail) (📥 250K · ⏱️ 15.06.2026):
	```
...
- [GitHub](https://github.com/django-cms/django-cms) (👨‍💻 600 · 🔀 3.2K · 📦 5.5K):

	```
	git clone https://github.com/django-cms/django-cms
	```
- [PyPi](https://pypi.org/project/django-cms) (📥 130K / month · 📦 370 · ⏱️ 06.08.2026):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 100 · 🔀 320 · 📦 500):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 8.5K / month · 📦 41 · ⏱️ 07.08.2026):
	```
	pip install lektor
	```
- [Conda](https://anaconda.org/conda-forge/lektor) (📥 280K · ⏱️ 09.08.2026):
	```
	conda install -c conda-forge lektor
	```
</details>
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉18 ·  ⭐ 1.1K) - A Django-based CMS with a focus on extensibility and concise code. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 240):

	```
	git clone https://github.com/feincms/feincms
	```
- [PyPi](https://pypi.org/project/feincms) (📥 7K / month · 📦 15 · ⏱️ 11.02.2026):
	```
	pip install feincms
	```
</details>
...
- <b><a href="https://github.com/stephenmcd/mezzanine">mezzanine</a></b> (🥈24 ·  ⭐ 4.8K · 💀) - CMS framework for Django. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/Kotti/Kotti">Kotti</a></b> (🥉13 ·  ⭐ 410 · 💀) - Kotti is a high-level, Pythonic web application framework based on.. <code><a href="https://tldrlegal.com/search?q=BSD">❗️BSD</a></code>
</details>
<br>
...
- [GitHub](https://github.com/SeleniumHQ/selenium) (👨‍💻 940 · 🔀 8.7K · 📦 410K):

	```
	git clone https://github.com/SeleniumHQ/selenium
	```
- [PyPi](https://pypi.org/project/selenium) (📥 58M / month · 📦 8K · ⏱️ 10.08.2026):
	```
	pip install selenium
	```
- [Conda](https://anaconda.org/conda-forge/selenium) (📥 3.3M · ⏱️ 11.08.2026):
	```
...
- [GitHub]() (👨‍💻 210 · 🔀 510 · 📦 520K):
	...
	```
- [PyPi](https://pypi.org/project/coverage) (📥 330M / month · 📦 25K · ⏱️ 06.08.2026):
	```
	pip install coverage
	```
- [Conda](https://anaconda.org/conda-forge/coverage) (📥 37M · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 400 · 🔀 3.2K · 📦 18K):
	...
	```
- [PyPi](https://pypi.org/project/locust) (📥 14M / month · 📦 320 · ⏱️ 01.08.2026):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 370K · ⏱️ 01.08.2026):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 150 · 🔀 370 · 📦 55K):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 72M / month · 📦 3.8K · ⏱️ 03.07.2026):
	```
...
- [GitHub](https://github.com/mitmproxy/mitmproxy) (👨‍💻 620 · 🔀 4.6K · 📦 5.5K):
	...
	```
- [PyPi](https://pypi.org/project/mitmproxy) (📥 6.3M / month · 📦 270 · ⏱️ 12.05.2026):
	```
...
- [GitHub](https://github.com/Microsoft/playwright-python) (🔀 1.2K):
	...
	```
- [PyPi](https://pypi.org/project/playwright) (📥 99M / month · 📦 7.5K · ⏱️ 31.07.2026):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 170 · 🔀 430 · 📦 12K):
	...
	```
- [PyPi](https://pypi.org/project/vcrpy) (📥 27M / month · 📦 690 · ⏱️ 04.07.2026):
	```
	pip install vcrpy
	```
...
<details><summary><b><a href="https://github.com/seleniumbase/SeleniumBase">SeleniumBase</a></b> (🥈29 ·  ⭐ 13K) - APIs for web automation, testing, and bypassing bot-detection. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/seleniumbase/SeleniumBase) (👨‍💻 40 · 🔀 1.6K · 📦 2.8K):
	...
	```
- [PyPi](https://pypi.org/project/seleniumbase) (📥 2.8M / month · 📦 130 · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/jazzband/django-silk) (👨‍💻 170 · 🔀 370 · 📦 6.5K):

	```
	git clone https://github.com/jazzband/django-silk
	```
- [PyPi](https://pypi.org/project/django-silk) (📥 2.6M / month · 📦 47 · ⏱️ 13.08.2026):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 85 · 🔀 220 · 📦 1.1K):
	...
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 7.1M / month · 📦 94 · ⏱️ 25.07.2026):
	```
...
- [GitHub](https://github.com/stoplightio/prism) (👨‍💻 110 · 🔀 410 · 📦 830):
	...
	```
- [npm](https://www.npmjs.com/package/@stoplight/prism-cli) (📥 740K / month · 📦 99 · ⏱️ 17.07.2026):
	```
	npm install @stoplight/prism-cli
	```
</details>
<details><summary><b><a href="https://github.com/cobrateam/splinter">splinter</a></b> (🥈26 ·  ⭐ 2.8K · 💤) - splinter - python test framework for web applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 510 · 📦 7.2K):
...
- [GitHub](https://github.com/taverntesting/tavern) (👨‍💻 70 · 🔀 200 · 📦 910):

	```
	git clone https://github.com/taverntesting/tavern
	```
- [PyPi](https://pypi.org/project/tavern) (📥 250K / month · 📦 15 · ⏱️ 14.06.2026):
	```
	pip install tavern
	```
</details>
<details><summary><b><a href="https://github.com/pnuckowski/aioresponses">aioresponses</a></b> (🥈26 ·  ⭐ 560) - Aioresponses is a helper for mock/fake web requests in python.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pnuckowski/aioresponses) (👨‍💻 60 · 🔀 100):

	```
	git clone https://github.com/pnuckowski/aioresponses
	```
- [PyPi](https://pypi.org/project/aioresponses) (📥 8.1M / month · 📦 880 · ⏱️ 23.06.2026):
	```
...
- [GitHub](https://github.com/robotframework/SeleniumLibrary) (👨‍💻 130 · 🔀 780):
...
- [PyPi](https://pypi.org/project/robotframework-seleniumlibrary) (📥 2M / month · 📦 160 · ⏱️ 17.05.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robotframework-seleniumlibrary) (📥 140K · ⏱️ 17.05.2026):
	```
...
- [GitHub](https://github.com/revsys/django-test-plus) (👨‍💻 38 · 🔀 63 · 📦 3.5K):
	...
	```
- [PyPi](https://pypi.org/project/django-test-plus) (📥 140K / month · 📦 8 · ⏱️ 02.08.2026):
	```
	pip install django-test-plus
	```
- [Conda](https://anaconda.org/conda-forge/django-test-plus) (📥 120K · ⏱️ 02.08.2026):
	```
...
- [GitHub](https://github.com/Pylons/webtest) (👨‍💻 98 · 🔀 110 · 📦 13K):
	...
	```
- [PyPi](https://pypi.org/project/webtest) (📥 1.6M / month · 📦 350 · ⏱️ 06.10.2025):
	```
	pip install webtest
	```
...
<details><summary><b><a href="https://github.com/model-bakers/model_bakery">Model Bakery</a></b> (🥉23 ·  ⭐ 990) - Object factory for Django. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/model-bakers/model_bakery) (👨‍💻 70 · 🔀 110):

	```
	git clone https://github.com/model-bakers/model_bakery
	```
- [PyPi](https://pypi.org/project/model_bakery) (📥 2.1M / month · 📦 120 · ⏱️ 23.06.2026):
	```
	pip install model_bakery
	```
- [Conda](https://anaconda.org/conda-forge/model_bakery) (📥 43K · ⏱️ 28.07.2026):
	```
...
- [GitHub](https://github.com/yashaka/selene) (👨‍💻 45 · 🔀 180 · 📦 6K):
...
- [GitHub]() (👨‍💻 13 · 🔀 510 · 📦 760):
	...
	```
- [PyPi](https://pypi.org/project/helium) (📥 21K / month · 📦 37 · ⏱️ 07.07.2026):
	```
	pip install helium
	```
</details>
...
- [GitHub](https://github.com/pytest-dev/pytest-flask) (👨‍💻 38 · 🔀 89):
...
- [PyPi](https://pypi.org/project/pytest-flask) (📥 1.4M / month · 📦 200 · ⏱️ 23.10.2023):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytest-flask) (📥 180K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/tryolabs/requestium) (👨‍💻 18 · 🔀 140 · 📦 110):
	...
	```
- [PyPi](https://pypi.org/project/requestium) (📥 84K / month · 📦 6 · ⏱️ 19.01.2026):
	```
...
- [GitHub](https://github.com/Pylons/pyramid_debugtoolbar) (👨‍💻 71 · 🔀 83):
	...
	```
- [PyPi](https://pypi.org/project/pyramid_debugtoolbar) (📥 1.8M / month · 📦 46 · ⏱️ 05.02.2024):
	```
	pip install pyramid_debugtoolbar
	```
- [Conda](https://anaconda.org/conda-forge/pyramid_debugtoolbar) (📥 9.6K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/mockoon/mockoon) (👨‍💻 69 · 🔀 460 · 📦 230):
...
- [GitHub](https://github.com/cdent/gabbi) (👨‍💻 30 · 🔀 36):
...
<details><summary><b><a href="https://github.com/httprunner/httprunner">httprunner</a></b> (🥉16 ·  ⭐ 4.3K · 💤) - HttpRunner API/UI. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/fsociety-team/fsociety">fsociety</a></b> (🥉16 ·  ⭐ 1.6K · 💤) - A Modular Penetration Testing Framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/fsociety-team/fsociety) (👨‍💻 12 · 🔀 190):
...
- <b><a href="https://github.com/gabrielfalcao/HTTPretty">HTTPretty</a></b> (🥈26 ·  ⭐ 2.1K · 💀) - Intercept HTTP requests at the Python socket level. Fakes the.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/FactoryBoy/factory_boy">factory_boy</a></b> (🥈25 ·  ⭐ 3.6K · 💀) - A test fixtures replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/wolever/parameterized">parameterized</a></b> (🥈25 ·  ⭐ 840 · 💀) - Parameterized testing with any Python test framework. <code><a href="https://tldrlegal.com/search?q=BSD-2-Clause-FreeBSD">❗️BSD-2-Clause-FreeBSD</a></code>
- <b><a href="https://github.com/jarus/flask-testing">flask-testing</a></b> (🥈25 ·  ⭐ 500 · 💀) - Unittest extensions for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/apiaryio/dredd">Dredd</a></b> (🥈24 ·  ⭐ 4.2K · 💀) - Language-agnostic HTTP API Testing Tool. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/miyakogi/pyppeteer">pyppeteer</a></b> (🥈24 ·  ⭐ 3.9K · 💀) - Headless chrome/chromium automation library (unofficial port of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/patrys/httmock">httmock</a></b> (🥉23 ·  ⭐ 470 · 💀) - A mocking library for requests. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://github.com/pytest-dev/pytest-splinter">pytest-splinter</a></b> (🥉21 ·  ⭐ 260 · 💀) - pytest splinter and selenium integration for anyone.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/yandex/yandex-tank">yandex-tank</a></b> (🥉15 ·  ⭐ 2.5K · 💀) - Load and performance benchmark tool. <code><a href="https://tldrlegal.com/search?q=LGPL-2.0">❗️LGPL-2.0</a></code>
- <b><a href="https://github.com/golemhq/golem">golem</a></b> (🥉14 ·  ⭐ 490 · 💀) - A complete test automation tool. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/facebookarchive/huxley">huxley</a></b> (🥉12 ·  ⭐ 4.1K · 💀) - A testing system for catching visual regressions in Web.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://github.com/flipkart-incubator/Astra">Astra</a></b> (🥉11 ·  ⭐ 2.6K · 💀) - Automated Security Testing For REST APIs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
</details>
<br>
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 230 · 🔀 730 · 📦 170K):
	...
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 3.1M / month · 📦 510 · ⏱️ 29.07.2026):
	```
	pip install django-crispy-forms
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 260K · ⏱️ 01.03.2026):
	```
	conda install -c conda-forge django-crispy-forms
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/django-formtools">django-formtools</a></b> (🥉27 ·  ⭐ 880) - A set of high-level abstractions for Django forms. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/jazzband/django-formtools) (👨‍💻 79 · 🔀 140 · 📦 12K):

	```
	git clone https://github.com/jazzband/django-formtools
	```
- [PyPi](https://pypi.org/project/django-formtools) (📥 4M / month · 📦 100 · ⏱️ 09.07.2026):
	```
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 850):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 48K / month · 📦 30 · ⏱️ 26.02.2026):
	```
	pip install deform
	```
</details>
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 190 · 🔀 900 · 📦 520K):
	...
	```
- [PyPi](https://pypi.org/project/markdown) (📥 130M / month · 📦 7.5K · ⏱️ 30.07.2026):
	```
	pip install markdown
	```
- [Conda](https://anaconda.org/conda-forge/markdown) (📥 13M · ⏱️ 31.07.2026):
	```
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 65 · 🔀 290 · 📦 380K):

	```
	git clone https://github.com/lepture/mistune
	```
- [PyPi](https://pypi.org/project/mistune) (📥 79M / month · 📦 1.7K · ⏱️ 22.07.2026):
	```
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 29M · ⏱️ 22.07.2026):
	```
	conda install -c conda-forge mistune
	```
</details>
<details><summary><b><a href="https://github.com/executablebooks/markdown-it-py">markdown-it-py</a></b> (🥈32 ·  ⭐ 1.3K) - Markdown parser, done right. 100% CommonMark support,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/executablebooks/markdown-it-py) (👨‍💻 35 · 🔀 100 · 📦 390K):

	```
	git clone https://github.com/executablebooks/markdown-it-py
	```
- [PyPi](https://pypi.org/project/markdown-it-py) (📥 630M / month · 📦 2.7K · ⏱️ 07.05.2026):
	```
	pip install markdown-it-py
	```
- [Conda](https://anaconda.org/conda-forge/markdown-it-py) (📥 22M · ⏱️ 07.05.2026):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 66 · 🔀 270 · 📦 63K):

	```
	git clone https://github.com/facelessuser/pymdown-extensions
	```
- [PyPi](https://pypi.org/project/pymdown-extensions) (📥 26M / month · 📦 2.7K · ⏱️ 02.07.2026):
	```
	pip install pymdown-extensions
	```
- [Conda](https://anaconda.org/conda-forge/pymdown-extensions) (📥 850K · ⏱️ 02.07.2026):
	```
	conda install -c conda-forge pymdown-extensions
	```
</details>
<details><summary><b><a href="https://github.com/getpelican/pelican">pelican</a></b> (🥈28 ·  ⭐ 13K) - Static site generator that supports Markdown and reST syntax... <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>

- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 480 · 🔀 1.8K · 📦 8.8K):
...
- [PyPi](https://pypi.org/project/pelican) (📥 86K / month · 📦 280 · ⏱️ 20.04.2026):
	...
	pip install pelican
	```
- [Conda](https://anaconda.org/conda-forge/pelican) (📥 510K · ⏱️ 21.04.2026):
	```
...
- [GitHub](https://github.com/trentm/python-markdown2) (👨‍💻 87 · 🔀 440):

	```
	git clone https://github.com/trentm/python-markdown2
	```
- [PyPi](https://pypi.org/project/markdown2) (📥 9.8M / month · 📦 680 · ⏱️ 02.03.2026):
	```
...
- [GitHub](https://github.com/miyuchina/mistletoe) (👨‍💻 45 · 🔀 130 · 📦 1.8K):

	```
	git clone https://github.com/miyuchina/mistletoe
	```
- [PyPi](https://pypi.org/project/mistletoe) (📥 1.9M / month · 📦 240 · ⏱️ 11.07.2026):
	```
...
- [GitHub](https://github.com/agusmakmun/django-markdown-editor) (👨‍💻 46 · 🔀 1.3K · 📦 1.2K):

	```
	git clone https://github.com/agusmakmun/django-markdown-editor
	```
- [PyPi](https://pypi.org/project/martor) (📥 62K / month · 📦 22 · ⏱️ 22.06.2026):
	```
	pip install martor
	```
</details>
...
- [GitHub](https://github.com/neutronX/django-markdownx) (👨‍💻 41 · 🔀 160 · 📦 2.9K):
...
- <b><a href="https://github.com/Alir3z4/html2text">html2text</a></b> (🥉27 ·  ⭐ 1.9K · 💀) - Convert HTML to Markdown-formatted text. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
- <b><a href="https://github.com/joeyespo/grip">grip</a></b> (🥉21 ·  ⭐ 6.4K · 💀) - Preview GitHub README.md files locally before committing them. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/cmacmackin/markdown-include">markdown-include</a></b> (🥉20 ·  ⭐ 100 · 💀) - Provides syntax for Python-Markdown which allows for.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
</details>
<br>
...
🔗&nbsp;<b><a href="https://github.com/public-apis/public-apis">Public APIs</a></b> ( ⭐ 320K · 💀)  - A collective list of free APIs.
...
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥇36 ·  ⭐ 8.9K) - The official Python client library for Googles.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 200 · 🔀 2.6K · 📦 290K):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 190M / month · 📦 4.9K · ⏱️ 25.06.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 5.9M · ⏱️ 25.06.2026):
	```
...
- [GitHub](https://github.com/gitpython-developers/GitPython) (👨‍💻 390 · 🔀 990 · 📦 430K):

	```
	git clone https://github.com/gitpython-developers/GitPython
	```
- [PyPi](https://pypi.org/project/gitpython) (📥 280M / month · 📦 10K · ⏱️ 10.08.2026):
	```
	pip install gitpython
	```
- [Conda](https://anaconda.org/conda-forge/gitpython) (📥 18M · ⏱️ 11.08.2026):
	```
	conda install -c conda-forge gitpython
	```
</details>
<details><summary><b><a href="https://github.com/python-telegram-bot/python-telegram-bot">python-telegram-bot</a></b> (🥇33 ·  ⭐ 29K) - We have made you a wrapper you cant refuse. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/python-telegram-bot/python-telegram-bot) (👨‍💻 210 · 🔀 6.1K · 📦 160K):

	```
	git clone https://github.com/python-telegram-bot/python-telegram-bot
	```
- [PyPi](https://pypi.org/project/python-telegram-bot) (📥 41M / month · 📦 1.5K · ⏱️ 12.06.2026):
	```
	pip install python-telegram-bot
	```
- [Conda](https://anaconda.org/conda-forge/python-telegram-bot) (📥 220K · ⏱️ 13.06.2026):
	```
...
- [GitHub](https://github.com/tweepy/tweepy) (👨‍💻 250 · 🔀 4.5K · 📦 66K):
	...
	```
- [PyPi](https://pypi.org/project/tweepy) (📥 4.8M / month · 📦 630 · ⏱️ 02.07.2026):
	```
	pip install tweepy
	```
- [Conda](https://anaconda.org/conda-forge/tweepy) (📥 570K · ⏱️ 03.07.2026):
	```
	conda install -c conda-forge tweepy
	```
</details>
<details><summary><b><a href="https://github.com/Rapptz/discord.py">discord.py</a></b> (🥇32 ·  ⭐ 16K) - An API wrapper for Discord written in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/discord.py) (📥 7M / month · 📦 1.3K · ⏱️ 03.03.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/discord.py) (📥 40K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge discord.py
	```
</details>
<details><summary><b><a href="https://github.com/PyGithub/PyGithub">PyGithub</a></b> (🥇32 ·  ⭐ 7.7K) - Typed interactions with the GitHub API v3. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PyGithub/PyGithub) (👨‍💻 430 · 🔀 1.9K · 📦 75K):
...
- [PyPi](https://pypi.org/project/pygithub) (📥 77M / month · 📦 2.7K · ⏱️ 14.04.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pygithub) (📥 9.2M · ⏱️ 14.04.2026):
	```
...
- [GitHub](https://github.com/eternnoir/pyTelegramBotAPI) (👨‍💻 270 · 🔀 2.1K · 📦 65K):

	```
	git clone https://github.com/eternnoir/pyTelegramBotAPI
	```
- [PyPi](https://pypi.org/project/pytelegrambotapi) (📥 1.4M / month · 📦 350 · ⏱️ 18.07.2026):
	```
	pip install pytelegrambotapi
	```
</details>
<details><summary><b><a href="https://github.com/burnash/gspread">gspread</a></b> (🥈31 ·  ⭐ 7.4K) - Google Sheets Python API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/burnash/gspread) (👨‍💻 200 · 🔀 970 · 📦 55K):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 46M / month · 📦 540 · ⏱️ 14.05.2025):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/pytube/pytube) (👨‍💻 110 · 🔀 2.5K · 📦 58K):

	```
	git clone https://github.com/pytube/pytube
	```
- [PyPi](https://pypi.org/project/pytube) (📥 4.5M / month · 📦 540 · ⏱️ 07.05.2023):
	```
	pip install pytube
	```
- [Conda](https://anaconda.org/conda-forge/pytube) (📥 34K · ⏱️ 27.04.2026):
	```
	conda install -c conda-forge pytube
	```
</details>
<details><summary><b><a href="https://github.com/LonamiWebs/Telethon">Telethon</a></b> (🥈30 ·  ⭐ 12K) - Pure Python 3 MTProto API Telegram client library, for bots too!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/LonamiWebs/Telethon) (👨‍💻 210 · 🔀 1.6K · 📦 24):

	```
	git clone https://github.com/LonamiWebs/Telethon
	```
- [PyPi](https://pypi.org/project/telethon) (📥 3.9M / month · 📦 710 · ⏱️ 15.06.2026):
	```
	pip install telethon
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-resumable-media-python">google-resumable-media</a></b> (🥈30 ·  ⭐ 5.4K) - This library has moved to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-resumable-media-python) (👨‍💻 39 · 🔀 1.8K):

	```
	git clone https://github.com/googleapis/google-resumable-media-python
	```
- [PyPi](https://pypi.org/project/google-resumable-media) (📥 190M / month · 📦 320 · ⏱️ 06.08.2026):
	```
	pip install google-resumable-media
	```
- [Conda](https://anaconda.org/conda-forge/google-resumable-media) (📥 7.5M · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/praw-dev/praw) (👨‍💻 240 · 🔀 500 · 📦 28K):
	...
	```
- [PyPi](https://pypi.org/project/praw) (📥 1.9M / month · 📦 440 · ⏱️ 12.08.2026):
	```
	pip install praw
	```
...
<details><summary><b><a href="https://github.com/twilio/twilio-python">twilio</a></b> (🥈30 ·  ⭐ 2.1K) - A Python module for communicating with the Twilio API and generating TwiML. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/twilio/twilio-python) (👨‍💻 150 · 🔀 810 · 📦 60K):

	```
	git clone https://github.com/twilio/twilio-python
	```
- [PyPi](https://pypi.org/project/twilio) (📥 21M / month · 📦 690 · ⏱️ 11.08.2026):
	```
	pip install twilio
	```
- [Conda](https://anaconda.org/conda-forge/twilio) (📥 450K · ⏱️ 12.08.2026):
	```
...
- [GitHub](https://github.com/stripe/stripe-python) (👨‍💻 360 · 🔀 530):
	...
	```
- [PyPi](https://pypi.org/project/stripe) (📥 43M / month · 📦 760 · ⏱️ 13.08.2026):
	```
	pip install stripe
	```
...
<details><summary><b><a href="https://github.com/hvac/hvac">hvac</a></b> (🥈29 ·  ⭐ 1.3K · 💤) - Python 3.X client for HashiCorp Vault. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/hvac/hvac) (👨‍💻 210 · 🔀 390 · 📦 7.4K):

	```
	git clone https://github.com/hvac/hvac
	```
- [PyPi](https://pypi.org/project/hvac) (📥 30M / month · 📦 500 · ⏱️ 30.10.2025):
	```
	pip install hvac
	```
- [Conda](https://anaconda.org/conda-forge/hvac) (📥 840K · ⏱️ 30.10.2025):
	```
	conda install -c conda-forge hvac
	```
</details>
<details><summary><b><a href="https://github.com/ytdl-org/youtube-dl">youtube-dl</a></b> (🥈28 ·  ⭐ 140K) - Command-line program to download videos from YouTube.com and.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/ytdl-org/youtube-dl) (👨‍💻 1K · 🔀 11K):
...
<details><summary><b><a href="https://github.com/waditu/tushare">tushare</a></b> (🥈28 ·  ⭐ 15K) - TuShare is a utility for crawling historical data of China stocks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/waditu/tushare) (👨‍💻 34 · 🔀 4.4K · 📦 2.7K):
	...
	```
- [PyPi](https://pypi.org/project/tushare) (📥 530K / month · 📦 170 · ⏱️ 25.03.2026):
	```
	pip install tushare
	```
</details>
<details><summary><b><a href="https://spotipy.readthedocs.org/">spotipy</a></b> (🥈28 ·  ⭐ 5.4K) - A light weight Python library for the Spotify Web API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/slackapi/python-slack-sdk) (👨‍💻 190 · 🔀 860):
...
- [GitHub](https://github.com/mikf/gallery-dl) (👨‍💻 210 · 🔀 1.4K · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/gallery-dl) (📥 380K / month · 📦 38 · ⏱️ 01.08.2026):
	```
	pip install gallery-dl
	```
</details>
<details><summary><b><a href="https://github.com/slackapi/python-slack-sdk">python-slack-sdk</a></b> (🥉26 ·  ⭐ 4K · 📉) - Slack Developer Kit for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/slackapi/python-slack-sdk) (👨‍💻 190 · 🔀 860):
	...
	git clone https://github.com/slackapi/python-slack-sdk
	```
- [PyPi](https://pypi.org/project/slack-sdk) (📦 1.3K · ⏱️ 30.06.2026):
	```
	pip install slack-sdk
	```
- [Conda](https://anaconda.org/conda-forge/slack-sdk) (📥 940K · ⏱️ 01.07.2026):
	```
...
- [GitHub](https://github.com/ramnes/notion-sdk-py) (👨‍💻 44 · 🔀 170):

	```
	git clone https://github.com/ramnes/notion-sdk-py
	```
- [PyPi](https://pypi.org/project/notion-client) (📥 4.5M / month · 📦 290 · ⏱️ 12.05.2026):
	```
...
- [GitHub]() (👨‍💻 23 · 🔀 70 · 📦 3.6K):
	...
	```
- [PyPi](https://pypi.org/project/ghapi) (📥 390M / month · 📦 170 · ⏱️ 13.08.2026):
	```
	pip install ghapi
	```
</details>
...
- [GitHub](https://github.com/sherlock-project/sherlock) (👨‍💻 310 · 🔀 8.2K):
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 210 · 🔀 860 · 📦 390):
...
- [GitHub](https://github.com/wechatpy/wechatpy) (👨‍💻 100 · 🔀 830 · 📦 10K):
...
<details><summary><b><a href="https://github.com/ssut/py-googletrans">py-googletrans</a></b> (🥉24 ·  ⭐ 4.3K) - (unofficial) Googletrans: Free and Unlimited Google translate.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ssut/py-googletrans) (👨‍💻 31 · 🔀 740):

	```
	git clone https://github.com/ssut/py-googletrans
	```
- [PyPi](https://pypi.org/project/googletrans) (📥 3.2M / month · 📦 400 · ⏱️ 01.01.2025):
	```
...
- [GitHub](https://github.com/hardikvasa/google-images-download) (👨‍💻 41 · 🔀 2.1K):

	```
	git clone https://github.com/hardikvasa/google-images-download
	```
- [PyPi](https://pypi.org/project/google_images_download) (📥 2.6K / month · 📦 3 · ⏱️ 21.05.2019):
	```
	pip install google_images_download
	```
</details>
<details><summary><b><a href="https://github.com/scdl-org/scdl">scdl</a></b> (🥉20 ·  ⭐ 4K) - Download Music from Souncloud. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub]() (👨‍💻 53 · 🔀 390 · 📦 430):
	...
	```
- [PyPi](https://pypi.org/project/scdl) (📥 3.4K / month · 📦 5 · ⏱️ 05.07.2026):
	```
	pip install scdl
	```
</details>
<details><summary><b><a href="https://github.com/attardi/wikiextractor">WikiExtractor</a></b> (🥉20 ·  ⭐ 4K) - A tool for extracting plain text from Wikipedia dumps. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub]() (👨‍💻 41 · 🔀 1K · 📦 450):
	...
	```
- [PyPi](https://pypi.org/project/wikiextractor) (📥 4.9K / month · 📦 10 · ⏱️ 10.08.2026):
	```
...
- <b><a href="https://github.com/simple-salesforce/simple-salesforce">simple-salesforce</a></b> (🥈27 ·  ⭐ 1.9K) - A very simple Salesforce.com REST API client for.. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/taspinar/twitterscraper">twitterscraper</a></b> (🥉21 ·  ⭐ 2.4K · 💀) - Scrape Twitter for Tweets. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 34 · 🔀 270 · 📦 5.8K):

	```
	git clone https://github.com/kootenpv/yagmail
	```
- [PyPi](https://pypi.org/project/yagmail) (📥 350K / month · 📦 170 · ⏱️ 26.05.2026):
	```
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 67K · ⏱️ 26.05.2026):
	```
...
- [GitHub](https://github.com/sabuhish/fastapi-mail) (👨‍💻 56 · 🔀 110 · 📦 5.8K):

	```
	git clone https://github.com/sabuhish/fastapi-mail
	```
- [PyPi](https://pypi.org/project/fastapi-mail) (📥 2.7M / month · 📦 36 · ⏱️ 18.06.2026):
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 130 · 🔀 480 · 📦 62):
	...
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 4.2K / month · 📦 15 · ⏱️ 05.08.2026):
	```
	pip install modoboa
	```
</details>
...
- [GitHub](https://github.com/nylas/sync-engine) (👨‍💻 80 · 🔀 350):

	```
	git clone https://github.com/nylas/sync-engine
	```
- [PyPi](https://pypi.org/project/nylas) (📥 430K / month · 📦 10 · ⏱️ 21.07.2026):
	```
	pip install nylas
	```
</details>
...
- <b><a href="https://github.com/OfflineIMAP/offlineimap">offlineimap</a></b> (🥉20 ·  ⭐ 1.9K) - Read/sync your IMAP mailboxes (python2) [LEGACY: move to.. <code>❗Unlicensed</code>
...
<details><summary><b><a href="https://github.com/scrapy/scrapy">Scrapy</a></b> (🥇35 ·  ⭐ 63K) - Scrapy, a fast high-level web crawling & scraping framework for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/scrapy/scrapy) (👨‍💻 740 · 🔀 12K · 📦 56K):

	```
	git clone https://github.com/scrapy/scrapy
	```
- [PyPi](https://pypi.org/project/scrapy) (📥 3.4M / month · 📦 1.1K · ⏱️ 07.07.2026):
	```
	pip install scrapy
	```
...
- [GitHub](https://github.com/kurtmckee/feedparser) (👨‍💻 63 · 🔀 370 · 📦 100K):
	...
	```
- [PyPi](https://pypi.org/project/feedparser) (📥 23M / month · 📦 2.1K · ⏱️ 30.07.2026):
	```
	pip install feedparser
	```
- [Conda](https://anaconda.org/conda-forge/feedparser) (📥 3.9M · ⏱️ 08.08.2026):
	```
...
- [GitHub](https://github.com/facelessuser/soupsieve) (👨‍💻 18 · 🔀 52 · 📦 760K):

	```
	git clone https://github.com/facelessuser/soupsieve
	```
- [PyPi](https://pypi.org/project/soupsieve) (📥 460M / month · 📦 2K · ⏱️ 07.08.2026):
	```
	pip install soupsieve
	```
- [Conda](https://anaconda.org/conda-forge/soupsieve) (📥 39M · ⏱️ 08.08.2026):
	```
	conda install -c conda-forge soupsieve
	```
</details>
<details><summary><b><a href="https://github.com/adbar/trafilatura">trafilatura</a></b> (🥇29 ·  ⭐ 6.4K · 📈) - Python & Command-line tool to gather text and metadata on.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/adbar/trafilatura) (👨‍💻 67 · 🔀 400 · 📦 10K):

	```
	git clone https://github.com/adbar/trafilatura
	```
- [PyPi](https://pypi.org/project/trafilatura) (📥 14M / month · 📦 1.1K · ⏱️ 31.07.2026):
	```
...
- [GitHub](https://github.com/scrapy/parsel) (👨‍💻 55 · 🔀 160 · 📦 40K):
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 29 · 🔀 89 · 📦 3.2K):

	```
	git clone https://github.com/coleifer/micawber
	```
- [PyPi](https://pypi.org/project/micawber) (📥 190K / month · 📦 26 · ⏱️ 05.07.2026):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 26K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge micawber
	```
</details>
<details><summary><b><a href="https://github.com/maurosoria/dirsearch">dirsearch</a></b> (🥈23 ·  ⭐ 14K · 💤) - Web path scanner. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/maurosoria/dirsearch) (👨‍💻 110 · 🔀 2.4K · 📦 200):
	...
	```
- [PyPi](https://pypi.org/project/dirsearch) (📥 33K / month · 📦 1 · ⏱️ 03.10.2022):
	```
	pip install dirsearch
	```
</details>
<details><summary><b><a href="https://github.com/grangier/python-goose">python-goose</a></b> (🥈23 ·  ⭐ 3.9K) - Html Content / Article Extractor, web scrapping lib in Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/grangier/python-goose) (👨‍💻 36 · 🔀 830):
	...
	```
- [PyPi](https://pypi.org/project/goose3) (📥 85K / month · 📦 33 · ⏱️ 23.07.2026):
	```
	pip install goose3
	```
</details>
...
- [GitHub](https://github.com/scrapinghub/extruct) (👨‍💻 40 · 🔀 120 · 📦 1.5K):
	...
	```
- [PyPi](https://pypi.org/project/extruct) (📥 630K / month · 📦 38 · ⏱️ 08.11.2024):
	```
	pip install extruct
	```
</details>
...
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 160K / month · 📦 120 · ⏱️ 30.05.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mechanicalsoup) (📥 340K · ⏱️ 30.05.2025):
	```
	conda install -c conda-forge mechanicalsoup
	```
</details>
<details><summary><b><a href="https://github.com/lorien/grab">Grab</a></b> (🥉20 ·  ⭐ 2.4K · 💤) - Web Scraping Framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lorien/grab) (👨‍💻 67 · 🔀 280 · 📦 440):

	```
	git clone https://github.com/lorien/grab
	```
- [PyPi](https://pypi.org/project/grab) (📥 990 / month · 📦 5 · ⏱️ 18.09.2025):
	```
	pip install grab
	```
</details>
...
- [GitHub](https://github.com/Gerapy/Gerapy) (👨‍💻 17 · 🔀 650 · 📦 150):
	...
	```
- [PyPi](https://pypi.org/project/gerapy) (📥 750 / month · ⏱️ 19.07.2023):
	```
	pip install gerapy
	```
</details>
...
- [GitHub]() (🔀 200):
	...
	```
- [PyPi](https://pypi.org/project/gain) (📥 88 / month · 📦 2 · ⏱️ 22.05.2026):
	```
	pip install gain
	```
</details>
<details><summary><b><a href="https://github.com/Iploop/proxyclaw">iploop-sdk</a></b> (🥉10 · 🐣) - Residential proxy SDK with 66 site presets and built-in anti-detection (TLS.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Iploop/proxyclaw) (👨‍💻 3):

	```
	git clone https://github.com/Iploop/proxyclaw
	```
- [PyPi](https://pypi.org/project/iploop-sdk) (📥 59 / month · 📦 3 · ⏱️ 30.04.2026):
	```
...
- <b><a href="https://github.com/howie6879/ruia">ruia</a></b> (🥉18 ·  ⭐ 1.7K · 💀) - Async Python 3.6+ web scraping micro-framework based on asyncio. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://github.com/maxhumber/gazpacho">gazpacho</a></b> (🥉18 ·  ⭐ 760 · 💀) - The simple, fast, and modern web scraping library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/michaelhelmick/lassie">Lassie</a></b> (🥉17 ·  ⭐ 610 · 💀) - Web Content Retrieval for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/alirezamika/autoscraper">AutoScraper</a></b> (🥉16 ·  ⭐ 6.2K · 💀) - A Smart, Automatic, Fast and Lightweight Web Scraper for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/prometheus/client_python">Prometheus Client</a></b> (🥇32 ·  ⭐ 4.3K) - Python client for the Prometheus monitoring system. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/prometheus/client_python) (👨‍💻 180 · 🔀 870):
	...
	```
- [PyPi](https://pypi.org/project/prometheus-client) (📥 180M / month · 📦 4.8K · ⏱️ 24.07.2026):
	```
...
- [PyPi](https://pypi.org/project/sentry) (📥 2.2K / month · 📦 140 · ⏱️ 25.07.2023):
	...
	pip install sentry
	```
- [Conda](https://anaconda.org/conda-forge/sentry-sdk) (📥 1.9M · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/open-telemetry/opentelemetry-python) (👨‍💻 380 · 🔀 950):

	```
	git clone https://github.com/open-telemetry/opentelemetry-python
	```
- [PyPi](https://pypi.org/project/timing-asgi) (📥 680K / month · 📦 9 · ⏱️ 17.02.2026):
	```
	pip install timing-asgi
	```
- [Conda](https://anaconda.org/conda-forge/opentelemetry-api) (📥 4.5M · ⏱️ 16.07.2026):
	```
	conda install -c conda-forge opentelemetry-api
	```
</details>
<details><summary><b><a href="https://github.com/opentracing/opentracing-python">opentracing-python</a></b> (🥈22 ·  ⭐ 760 · 💤) - OpenTracing API for Python. This library is.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/opentracing/opentracing-python) (👨‍💻 34 · 🔀 160):

	```
	git clone https://github.com/opentracing/opentracing-python
	```
- [PyPi](https://pypi.org/project/opentracing) (📥 790K / month · 📦 170 · ⏱️ 19.11.2020):
	```
...
- [GitHub](https://github.com/allinurl/goaccess) (👨‍💻 190 · 🔀 1.2K · 📦 24):
...
- [GitHub](https://github.com/steinnes/timing-asgi) (👨‍💻 7 · 🔀 12 · 📦 190):
...
- <b><a href="https://github.com/PostHog/posthog">posthog</a></b> (🥇31 ·  ⭐ 38K) - PostHog is the leading platform for building self-driving.. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/yoobool/flask-state">flask-state</a></b> (🥉13 ·  ⭐ 610 · 💀) - Display machine state using Python3 with Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/streamlit/streamlit) (👨‍💻 1K · 🔀 4.4K · 📦 1M):

	```
	git clone https://github.com/streamlit/streamlit
	```
- [PyPi](https://pypi.org/project/streamlit) (📥 30M / month · 📦 7K · ⏱️ 05.08.2026):
	```
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 260 · 🔀 620 · 📦 19K):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 3.5M / month · 📦 710 · ⏱️ 12.08.2026):
	```
	pip install panel
	```
</details>
...
- [GitHub](https://github.com/zauberzeug/nicegui) (👨‍💻 230 · 🔀 940 · 📦 3K):

	```
	git clone https://github.com/zauberzeug/nicegui
	```
- [PyPi](https://pypi.org/project/nicegui) (📥 1.2M / month · 📦 520 · ⏱️ 12.08.2026):
	```
	pip install nicegui
	```
- [Conda](https://anaconda.org/conda-forge/nicegui) (📥 170K · ⏱️ 30.07.2026):
	```
	conda install -c conda-forge nicegui
	```
- [Docker Hub](https://hub.docker.com/r/zauberzeug/nicegui) (📥 90K · ⭐ 12 · ⏱️ 12.08.2026):
	```
	docker pull zauberzeug/nicegui
	```
</details>
<details><summary><b><a href="https://github.com/Kitware/trame">trame</a></b> (🥈24 ·  ⭐ 670) - Trame lets you weave various components and technologies into a Web.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Kitware/trame) (👨‍💻 32 · 🔀 80 · 📦 820):

	```
	git clone https://github.com/Kitware/trame
	```
- [PyPi](https://pypi.org/project/trame) (📥 1.2M / month · 📦 190 · ⏱️ 15.05.2026):
	```
	pip install trame
	```
</details>
<details><summary><b><a href="https://github.com/h2oai/wave">wave</a></b> (🥈22 ·  ⭐ 4.2K) - Realtime Web Apps and Dashboards for Python and R. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/h2oai/wave) (👨‍💻 65 · 🔀 370):

	```
	git clone https://github.com/h2oai/wave
	```
- [PyPi](https://pypi.org/project/wave) (📥 58K / month · 📦 120 · ⏱️ 15.03.2024):
	```
	pip install wave
	```
</details>
...
- <b><a href="https://github.com/pywebio/PyWebIO">PyWebIO</a></b> (🥉21 ·  ⭐ 4.8K · 💀) - Write interactive web app in script way. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/rmorshea/idom">idom</a></b> (🥉20 ·  ⭐ 8.1K · 💀) - Its React, but in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/flaskbb/flaskbb">flaskbb</a></b> (🥉18 ·  ⭐ 2.7K) - A classic Forum Software in Python using Flask. <code>❗Unlicensed</code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/rafalp/Misago">Misago</a></b> (🥉14 ·  ⭐ 2.5K · 💀) - Misago is fully featured modern forum application that is fast,.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code>
</details>
<br>
...
- [GitHub]() (👨‍💻 330 · 🔀 1.1K · 📦 110K):

	```
	git clone https://github.com/jazzband/django-debug-toolbar
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 9.1M / month · 📦 400 · ⏱️ 10.08.2026):
	```
	pip install django-debug-toolbar
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 670K · ⏱️ 10.08.2026):
	```
	conda install -c conda-forge django-debug-toolbar
	```
</details>
<details><summary><b><a href="https://flask-admin.readthedocs.io">flask-admin</a></b> (🥇29 ·  ⭐ 6.1K) - Simple and extensible admin interface framework for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/flask-admin) (📥 2.5M / month · 📦 210 · ⏱️ 07.05.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-admin) (📥 470K · ⏱️ 07.05.2026):
	```
...
- [PyPi](https://pypi.org/project/django-grappelli) (📥 340K / month · 📦 34 · ⏱️ 29.04.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-grappelli) (📥 400K · ⏱️ 29.04.2026):
	```
...
- [GitHub](https://github.com/fabiocaccamo/django-admin-interface) (👨‍💻 46 · 🔀 200 · 📦 5.3K):
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 770 · 📦 3.4K):
	...
	```
- [PyPi](https://pypi.org/project/django-jet) (📥 15K / month · 📦 8 · ⏱️ 18.10.2018):
	```
...
- <b><a href="https://github.com/jazzband/django-admin2">django-admin2</a></b> (🥉16 ·  ⭐ 1.2K · 💀) - Extendable, adaptable rewrite of django.contrib.admin. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/schenkd/nginx-ui">nginx-ui</a></b> (🥉14 ·  ⭐ 4.5K · 💀) - Nginx UI allows you to access and modify the nginx configurations.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
<br>
...
- [GitHub](https://github.com/kong/kong) (👨‍💻 450 · 🔀 5.2K · 📦 25):

	```
	git clone https://github.com/kong/kong
	```
- [Docker Hub](https://hub.docker.com/r/_/kong) (📥 360M · ⭐ 830 · ⏱️ 04.08.2026):
	```
	docker pull kong
	```
</details>
...
- [GitHub](https://github.com/TykTechnologies/tyk) (👨‍💻 290 · 🔀 1.2K):
...
<details><summary><b><a href="https://github.com/corydolphin/flask-cors">flask-cors</a></b> (🥇32 ·  ⭐ 930) - Cross Origin Resource Sharing ( CORS ) support for Flask. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/corydolphin/flask-cors) (👨‍💻 54 · 🔀 150 · 📦 460K):

	```
	git clone https://github.com/corydolphin/flask-cors
	```
- [PyPi](https://pypi.org/project/flask-cors) (📥 59M / month · 📦 1.1K · ⏱️ 08.06.2026):
	```
	pip install flask-cors
	```
- [Conda](https://anaconda.org/conda-forge/flask-cors) (📥 2.1M · ⏱️ 09.06.2026):
	```
	conda install -c conda-forge flask-cors
	```
</details>
<details><summary><b><a href="https://flask-sqlalchemy.readthedocs.io">flask-sqlalchemy</a></b> (🥇30 ·  ⭐ 4.3K · 💤) - Add SQLAlchemy support to your Flask application. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/flask-sqlalchemy) (📥 30M / month · 📦 1.3K · ⏱️ 11.09.2023):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-sqlalchemy) (📥 1M · ⏱️ 01.12.2025):
	```
...
- [GitHub](https://github.com/alisaifee/flask-limiter) (👨‍💻 46 · 🔀 130 · 📦 23K):
...
- [GitHub](https://github.com/maxcountryman/flask-bcrypt) (👨‍💻 25 · 🔀 64 · 📦 82K):
	...
	```
- [PyPi](https://pypi.org/project/flask-bcrypt) (📥 2.1M / month · 📦 120 · ⏱️ 05.04.2022):
	```
...
- [GitHub]() (👨‍💻 130 · 🔀 170 · 📦 8.6K):
	...
	```
- [PyPi](https://pypi.org/project/flask-security) (📥 150K / month · 📦 73 · ⏱️ 12.08.2026):
	```
	pip install flask-security
	```
- [Conda](https://anaconda.org/conda-forge/flask-security) (📥 200K · ⏱️ 25.05.2026):
	```
...
- [GitHub]() (👨‍💻 24 · 🔀 69 · 📦 910):
	...
	```
- [PyPi](https://pypi.org/project/flask_pydantic) (📥 620K / month · 📦 11 · ⏱️ 22.12.2025):
	```
	pip install flask_pydantic
	```
</details>
<details><summary><b><a href="https://github.com/plangrid/flask-rebar">flask-rebar</a></b> (🥉20 ·  ⭐ 240) - Flask-Rebar combines flask, marshmallow, and swagger for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code> <code><img src="https://www.openapis.org/wp-content/uploads/sites/3/2016/11/favicon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/plangrid/flask-rebar) (👨‍💻 48 · 🔀 38 · 📦 58):

	```
	git clone https://github.com/plangrid/flask-rebar
	```
- [PyPi](https://pypi.org/project/flask-rebar) (📥 6.1K / month · 📦 7 · ⏱️ 26.06.2026):
	```
...
- [GitHub](https://github.com/thomaxxl/safrs) (👨‍💻 17 · 🔀 73 · 📦 610):
	...
	```
- [PyPi](https://pypi.org/project/safrs) (📥 730 / month · 📦 2 · ⏱️ 09.03.2026):
	```
	pip install safrs
	```
</details>
...
- <b><a href="https://github.com/cookiecutter-flask/cookiecutter-flask">cookiecutter-flask</a></b> (🥉12 ·  ⭐ 4.5K · 💀) - A flask template with Bootstrap, asset.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub]() (👨‍💻 110 · 🔀 300 · 📦 1.9K):
	...
	```
- [PyPi](https://pypi.org/project/sqladmin) (📥 950K / month · 📦 51 · ⏱️ 06.08.2026):
	```
...
- [GitHub](https://github.com/koxudaxi/fastapi-code-generator) (👨‍💻 36 · 🔀 150 · 📦 260):
	...
	```
- [PyPi](https://pypi.org/project/fastapi-code-generator) (📥 46K / month · 📦 10 · ⏱️ 01.07.2026):
	```
	pip install fastapi-code-generator
	```
</details>
<details><summary><b><a href="https://github.com/stephenhillier/starlette_exporter">starlette_exporter</a></b> (🥉16 ·  ⭐ 420) - Prometheus exporter for Starlette and FastAPI. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://fastapi.tiangolo.com/img/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/stephenhillier/starlette_exporter) (👨‍💻 27 · 🔀 38):
	...
	```
- [PyPi](https://pypi.org/project/starlette_exporter) (📦 41 · ⏱️ 29.07.2026):
	```
	pip install starlette_exporter
	```
</details>
<details><summary><b><a href="https://fastapi-mvc.github.io/fastapi-mvc/">fastapi-mvc</a></b> (🥉13 ·  ⭐ 800) - Developer productivity tool for making high-quality FastAPI.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://fastapi.tiangolo.com/img/favicon.png" style="display:inline;" width="13" height="13"></code></summary>
...
- <b><a href="https://github.com/mmerickel/pyramid_services">pyramid_services</a></b> (🥉14 ·  ⭐ 81 · 💀) - A service layer for pyramid. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://trypyramid.com/img/pyramid-16x16.png" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
- [GitHub](https://github.com/django-extensions/django-extensions) (👨‍💻 610 · 🔀 1.2K · 📦 270K):
...
- [PyPi](https://pypi.org/project/django-extensions) (📥 14M / month · 📦 550 · ⏱️ 11.04.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-extensions) (📥 1.4M · ⏱️ 22.04.2025):
	```
...
- [PyPi](https://pypi.org/project/django-filter) (📥 17M / month · 📦 1.2K · ⏱️ 11.07.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-filter) (📥 400K · ⏱️ 12.07.2026):
	```
	conda install -c conda-forge django-filter
	```
</details>
<details><summary><b><a href="https://github.com/joke2k/django-environ">django-environ</a></b> (🥇31 ·  ⭐ 3.2K) - Django-environ allows you to utilize 12factor inspired.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/joke2k/django-environ) (👨‍💻 110 · 🔀 340 · 📦 280K):

	```
	git clone https://github.com/joke2k/django-environ
	```
- [PyPi](https://pypi.org/project/django-environ) (📥 8.5M / month · 📦 520 · ⏱️ 18.06.2026):
	```
...
- [GitHub](https://github.com/django-import-export/django-import-export) (👨‍💻 250 · 🔀 820 · 📦 130K):
...
- [GitHub](https://github.com/typeddjango/django-stubs) (👨‍💻 350 · 🔀 560 · 📦 15K):

	```
	git clone https://github.com/typeddjango/django-stubs
	```
- [PyPi](https://pypi.org/project/django-stubs) (📥 11M / month · 📦 630 · ⏱️ 12.08.2026):
	```
	pip install django-stubs
	```
- [Conda](https://anaconda.org/conda-forge/django-stubs) (📥 93K · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/adamchainz/django-cors-headers) (👨‍💻 70 · 🔀 540 · 📦 320K):
	...
	```
- [PyPi](https://pypi.org/project/django-cors-headers) (📥 22M / month · 📦 510 · ⏱️ 18.09.2025):
	```
	pip install django-cors-headers
	```
- [Conda](https://anaconda.org/conda-forge/django-cors-headers) (📥 270K · ⏱️ 18.09.2025):
	```
	conda install -c conda-forge django-cors-headers
	```
</details>
<details><summary><b><a href="https://github.com/etianen/django-reversion">django-reversion</a></b> (🥇29 ·  ⭐ 3.2K) - django-reversion is an extension to the Django web.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/etianen/django-reversion) (👨‍💻 200 · 🔀 490 · 📦 7.9K):
...
<details><summary><b><a href="https://github.com/django-mptt/django-mptt">django-mptt</a></b> (🥇29 ·  ⭐ 3K) - Utilities for implementing a modified pre-order traversal tree in.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/django-mptt/django-mptt) (👨‍💻 160 · 🔀 460 · 📦 24K):

	```
	git clone https://github.com/django-mptt/django-mptt
	```
- [PyPi](https://pypi.org/project/django-mptt) (📥 1.5M / month · 📦 270 · ⏱️ 02.06.2026):
	```
...
- [GitHub](https://github.com/jazzband/django-model-utils) (👨‍💻 140 · 🔀 370 · 📦 27K):

	```
	git clone https://github.com/jazzband/django-model-utils
	```
- [PyPi](https://pypi.org/project/django-model-utils) (📥 4.8M / month · 📦 500 · ⏱️ 04.09.2024):
	```
...
- [GitHub](https://github.com/yourlabs/django-autocomplete-light) (👨‍💻 200 · 🔀 460 · 📦 4.8K):
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 59 · 🔀 300 · 📦 30K):

	```
	git clone https://github.com/SmileyChris/django-countries
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 2.3M / month · 📦 140 · ⏱️ 10.06.2026):
	```
...
- [GitHub](https://github.com/vitalik/django-ninja) (👨‍💻 180 · 🔀 600):

	```
	git clone https://github.com/vitalik/django-ninja
	```
- [PyPi](https://pypi.org/project/django-ninja) (📥 3.2M / month · 📦 200 · ⏱️ 18.03.2026):
	```
	pip install django-ninja
	```
- [Conda](https://anaconda.org/conda-forge/django-ninja) (📥 48K · ⏱️ 23.03.2026):
	```
...
- [GitHub]() (👨‍💻 190 · 🔀 510 · 📦 7.3K):
	...
	```
- [PyPi](https://pypi.org/project/django-simple-history) (📥 4.5M / month · 📦 130 · ⏱️ 22.07.2026):
	```
	pip install django-simple-history
	```
</details>
<details><summary><b><a href="https://github.com/rq/django-rq">django-rq</a></b> (🥈28 ·  ⭐ 1.9K) - A simple app that provides django integration for RQ (Redis Queue). <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rq/django-rq) (👨‍💻 140 · 🔀 300 · 📦 4.4K):

	```
	git clone https://github.com/rq/django-rq
	```
- [PyPi](https://pypi.org/project/django-rq) (📥 1.1M / month · 📦 120 · ⏱️ 04.07.2026):
	```
	pip install django-rq
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/django-constance">django-constance</a></b> (🥈28 ·  ⭐ 1.9K) - Dynamic Django settings. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>
...
<details><summary><b><a href="https://github.com/django-commons/django-polymorphic">django-polymorphic</a></b> (🥈28 ·  ⭐ 1.8K) - Seamless polymorphic inheritance for Django models. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub]() (👨‍💻 150 · 🔀 300 · 📦 7.9K):
	...
	```
- [PyPi](https://pypi.org/project/django-polymorphic) (📥 2.5M / month · 📦 180 · ⏱️ 01.08.2026):
	```
	pip install django-polymorphic
	```
- [Conda](https://anaconda.org/conda-forge/django_polymorphic) (📥 250K · ⏱️ 01.08.2026):
	```
...
- [GitHub](https://github.com/jazzband/sorl-thumbnail) (👨‍💻 170 · 🔀 490 · 📦 16K):
...
- [GitHub]() (👨‍💻 120 · 🔀 320 · 📦 32K):
	...
	```
- [PyPi](https://pypi.org/project/django-phonenumber-field) (📥 6.8M / month · 📦 160 · ⏱️ 23.07.2026):
	```
...
- [GitHub](https://github.com/django-oscar/django-oscar) (👨‍💻 380 · 🔀 2.3K · 📦 1.2K):

	```
	git clone https://github.com/django-oscar/django-oscar
	```
- [PyPi](https://pypi.org/project/django-oscar) (📥 68K / month · 📦 47 · ⏱️ 05.08.2026):
	```
...
- [PyPi](https://pypi.org/project/django-webpack-loader) (📥 950K / month · 📦 70 · ⏱️ 13.05.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-webpack-loader) (📥 32K · ⏱️ 13.05.2026):
	```
...
- [GitHub]() (👨‍💻 78 · 🔀 220 · 📦 310K):
	...
	```
- [PyPi](https://pypi.org/project/dj-database-url) (📥 8.7M / month · 📦 360 · ⏱️ 19.02.2026):
	```
...
- [GitHub](https://github.com/typeddjango/djangorestframework-stubs) (👨‍💻 96 · 🔀 140 · 📦 4.5K):

	```
	git clone https://github.com/typeddjango/djangorestframework-stubs
	```
- [PyPi](https://pypi.org/project/djangorestframework-stubs) (📥 6.4M / month · 📦 120 · ⏱️ 12.08.2026):
	```
	pip install djangorestframework-stubs
	```
- [Conda](https://anaconda.org/conda-forge/djangorestframework-stubs) (📥 46K · ⏱️ 03.08.2026):
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 160 · 🔀 630):

	```
	git clone https://github.com/jazzband/django-taggit
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 2.1M / month · 📦 220 · ⏱️ 29.09.2024):
	```
...
<details><summary><b><a href="https://github.com/matthewwithanm/django-imagekit">django-imagekit</a></b> (🥈26 ·  ⭐ 2.4K · 📈) - Automated image processing for Django. Currently v6.0. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/noripyt/django-cachalot) (👨‍💻 40 · 🔀 160 · 📦 1K):

	```
	git clone https://github.com/noripyt/django-cachalot
	```
- [PyPi](https://pypi.org/project/django-cachalot) (📥 270K / month · 📦 12 · ⏱️ 10.08.2026):
	```
	pip install django-cachalot
	```
- [Conda](https://anaconda.org/conda-forge/django-cachalot) (📥 120K · ⏱️ 11.08.2026):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 260 · 📦 190K):
	...
	```
- [PyPi](https://pypi.org/project/django-bootstrap4) (📥 340K / month · 📦 89 · ⏱️ 03.01.2026):
	```
	pip install django-bootstrap4
	```
- [Conda](https://anaconda.org/conda-forge/django-bootstrap4) (📥 46K · ⏱️ 09.08.2025):
	```
...
- [GitHub](https://github.com/viewflow/django-fsm) (👨‍💻 70 · 🔀 310 · 📦 1.9K):
...
- [PyPi](https://pypi.org/project/django-fsm) (📥 560K / month · 📦 64 · ⏱️ 07.10.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-fsm) (📥 97K · ⏱️ 07.10.2025):
	```
...
- [GitHub](https://github.com/django-money/django-money) (👨‍💻 130 · 🔀 320):
...
<details><summary><b><a href="https://github.com/bennylope/django-organizations">django-organizations</a></b> (🥉25 ·  ⭐ 1.4K) - Multi-user accounts for Django projects. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/bennylope/django-organizations) (👨‍💻 54 · 🔀 220 · 📦 320):
	...
	```
- [PyPi](https://pypi.org/project/django-organizations) (📥 85K / month · 📦 7 · ⏱️ 03.07.2026):
	```
...
- [GitHub](https://github.com/mozilla/django-csp) (👨‍💻 67 · 🔀 110 · 📦 5.1K):
...
<details><summary><b><a href="https://github.com/rsinger86/django-lifecycle">django-lifecycle</a></b> (🥉24 ·  ⭐ 1.4K) - Declarative model lifecycle hooks, an alternative to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/rsinger86/django-lifecycle) (👨‍💻 42 · 🔀 96 · 📦 490):
...
- [GitHub](https://github.com/jazzband/django-configurations) (👨‍💻 74 · 🔀 140 · 📦 3.4K):
...
<details><summary><b><a href="http://archmonger.github.io/django-dbbackup/">django-dbbackup</a></b> (🥉23 ·  ⭐ 1.1K) - Management commands to help backup and restore a project.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/soynatan/django-easy-audit) (👨‍💻 58 · 🔀 200 · 📦 370):

	```
	git clone https://github.com/soynatan/django-easy-audit
	```
- [PyPi](https://pypi.org/project/django-easy-audit) (📥 110K / month · 📦 5 · ⏱️ 11.08.2026):
	```
	pip install django-easy-audit
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/django-robots">django-robots</a></b> (🥉23 ·  ⭐ 480) - A Django app for managing robots.txt files following the.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/jazzband/django-robots) (👨‍💻 45 · 🔀 100 · 📦 1.6K):

	```
	git clone https://github.com/jazzband/django-robots
	```
- [PyPi](https://pypi.org/project/django-robots) (📥 150K / month · 📦 13 · ⏱️ 09.12.2023):
	```
	pip install django-robots
	```
</details>
<details><summary><b><a href="https://github.com/django/channels">channels</a></b> (🥉22 ·  ⭐ 6.3K · 💤) - Developer-friendly asynchrony for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/django/channels) (👨‍💻 280 · 🔀 820 · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📦 440 · ⏱️ 20.11.2025):
	```
	pip install channels
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 290K · ⏱️ 20.11.2025):
	```
...
- [GitHub](https://github.com/jazzband/django-push-notifications) (👨‍💻 120 · 🔀 640):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter-django) (👨‍💻 480 · 🔀 3K · 📦 34):
	...
	```
- [PyPi](https://pypi.org/project/cookiecutter-django) (📥 52 / month · ⏱️ 15.01.2018):
	```
...
- [GitHub](https://github.com/browniebroke/django-codemod) (👨‍💻 30 · 🔀 19 · 📦 5):

	```
	git clone https://github.com/browniebroke/django-codemod
	```
- [PyPi](https://pypi.org/project/django-codemod) (📥 2.8K / month · ⏱️ 07.08.2026):
	```
...
- <b><a href="https://github.com/AndrewIngram/django-extra-views">django-extra-views</a></b> (🥉24 ·  ⭐ 1.4K · 💀) - Djangos class-based generic views are awesome, lets.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/un1t/django-cleanup">django-cleanup</a></b> (🥉24 ·  ⭐ 1.1K · 💀) - Automatically deletes old file for FileField and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/Koed00/django-q">django-q</a></b> (🥉23 ·  ⭐ 1.8K · 💀) - A multiprocessing distributed task queue for Django. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
...
<details><summary><b><a href="https://github.com/pallets/jinja">jinja</a></b> (🥇33 ·  ⭐ 11K · 💤) - A very fast and expressive template engine. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 340 · 🔀 1.7K · 📦 24):

	```
	git clone https://github.com/pallets/jinja
	```
- [PyPi](https://pypi.org/project/jinja2) (📥 740M / month · 📦 24K · ⏱️ 05.03.2025):
	```
	pip install jinja2
	```
- [Conda](https://anaconda.org/conda-forge/jinja2) (📥 75M · ⏱️ 30.11.2025):
	```
	conda install -c conda-forge jinja2
	```
</details>
<details><summary><b><a href="https://github.com/twisted/twisted">twisted</a></b> (🥇32 ·  ⭐ 6K) - Event-driven networking engine written in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/twisted/twisted) (👨‍💻 310 · 🔀 1.2K · 📦 110K):

	```
	git clone https://github.com/twisted/twisted
	```
- [PyPi](https://pypi.org/project/twisted) (📥 16M / month · 📦 1.3K · ⏱️ 11.05.2026):
	```
	pip install twisted
	```
...
- [GitHub](https://github.com/rthalley/dnspython) (👨‍💻 140 · 🔀 560 · 📦 460K):

	```
	git clone https://github.com/rthalley/dnspython
	```
- [PyPi](https://pypi.org/project/dnspython) (📥 340M / month · 📦 2.5K · ⏱️ 07.09.2025):
	```
	pip install dnspython
	```
- [Conda](https://anaconda.org/conda-forge/dnspython) (📥 8.1M · ⏱️ 08.09.2025):
	```
	conda install -c conda-forge dnspython
	```
</details>
<details><summary><b><a href="https://github.com/pyca/pynacl">pynacl</a></b> (🥇32 ·  ⭐ 1.2K) - Python binding to the Networking and Cryptography (NaCl) library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 78 · 🔀 260 · 📦 140K):

	```
	git clone https://github.com/pyca/pynacl
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 250M / month · 📦 1.7K · ⏱️ 01.01.2026):
	```
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 16M · ⏱️ 09.07.2026):
	```
	conda install -c conda-forge pynacl
	```
</details>
<details><summary><b><a href="https://github.com/pyca/pyopenssl">pyopenssl</a></b> (🥇32 ·  ⭐ 940) - A Python wrapper around the OpenSSL library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pyca/pyopenssl) (👨‍💻 120 · 🔀 430 · 📦 280K):

	```
	git clone https://github.com/pyca/pyopenssl
	```
- [PyPi](https://pypi.org/project/pyopenssl) (📥 280M / month · 📦 3.3K · ⏱️ 01.08.2026):
	```
	pip install pyopenssl
	```
- [Conda](https://anaconda.org/conda-forge/pyopenssl) (📥 51M · ⏱️ 02.08.2026):
	```
...
- [GitHub](https://github.com/kjd/idna) (👨‍💻 45 · 🔀 130 · 📦 2.5M):

	```
	git clone https://github.com/kjd/idna
	```
- [PyPi](https://pypi.org/project/idna) (📥 1.8B / month · 📦 11K · ⏱️ 02.06.2026):
	```
	pip install idna
	```
- [Conda](https://anaconda.org/conda-forge/idna) (📥 93M · ⏱️ 16.06.2026):
	```
...
- [GitHub](https://github.com/certifi/python-certifi) (👨‍💻 41 · 🔀 300 · 📦 5):
	...
	```
- [PyPi](https://pypi.org/project/certifi) (📥 1.9B / month · 📦 16K · ⏱️ 22.07.2026):
	```
	pip install certifi
	```
- [Conda](https://anaconda.org/conda-forge/certifi) (📥 200M · ⏱️ 22.07.2026):
	```
	conda install -c conda-forge certifi
	```
</details>
<details><summary><b><a href="https://github.com/sqlalchemy/mako">Mako</a></b> (🥈31 ·  ⭐ 450) - Mako Templates for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sqlalchemy/mako) (👨‍💻 63 · 🔀 83 · 📦 340K):

	```
	git clone https://github.com/sqlalchemy/mako
	```
- [PyPi](https://pypi.org/project/mako) (📥 210M / month · 📦 1.4K · ⏱️ 05.08.2026):
	```
	pip install mako
	```
- [Conda](https://anaconda.org/conda-forge/mako) (📥 14M · ⏱️ 05.08.2026):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 540 · 🔀 2.2K · 📦 24K):

	```
	git clone https://github.com/secdev/scapy
	```
- [PyPi](https://pypi.org/project/scapy) (📥 4.4M / month · 📦 760 · ⏱️ 13.04.2026):
	```
	pip install scapy
	```
...
- [GitHub](https://github.com/RDFLib/rdflib) (👨‍💻 210 · 🔀 600 · 📦 29K):

	```
	git clone https://github.com/RDFLib/rdflib
	```
- [PyPi](https://pypi.org/project/rdflib) (📥 17M / month · 📦 1.8K · ⏱️ 13.02.2026):
	```
	pip install rdflib
	```
...
<details><summary><b><a href="https://github.com/postmanlabs/httpbin">httpbin</a></b> (🥈29 ·  ⭐ 14K) - HTTP Request & Response Service, written in Python + Flask. <code><a href="http://bit.ly/3hkKRql">ISC</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/postmanlabs/httpbin) (👨‍💻 110 · 🔀 1.9K · 📦 1.8K):

	```
	git clone https://github.com/postmanlabs/httpbin
	```
- [PyPi](https://pypi.org/project/httpbin) (📥 480K / month · 📦 31 · ⏱️ 16.06.2026):
	```
	pip install httpbin
	```
</details>
<details><summary><b><a href="https://github.com/cgohlke/tifffile">tifffile</a></b> (🥈29 ·  ⭐ 660) - Read and write TIFF files. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/cgohlke/tifffile) (👨‍💻 1 · 🔀 160 · 📦 89K):

	```
	git clone https://github.com/cgohlke/tifffile
	```
- [PyPi](https://pypi.org/project/tifffile) (📥 30M / month · 📦 2.5K · ⏱️ 01.08.2026):
	```
	pip install tifffile
	```
- [Conda](https://anaconda.org/conda-forge/tifffile) (📥 9.9M · ⏱️ 01.08.2026):
	```
...
- [GitHub]() (👨‍💻 320 · 🔀 3.9K · 📦 6.6K):

	```
	git clone https://github.com/SecureAuthCorp/impacket
	```
- [PyPi](https://pypi.org/project/impacket) (📥 740K / month · 📦 180 · ⏱️ 19.05.2026):
	```
	pip install impacket
	```
</details>
<details><summary><b><a href="https://github.com/Gallopsled/pwntools">pwntools</a></b> (🥈28 ·  ⭐ 13K · 💤) - CTF framework and exploit development library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Gallopsled/pwntools) (👨‍💻 310 · 🔀 1.8K · 📦 2.3K):

	```
	git clone https://github.com/Gallopsled/pwntools
	```
- [PyPi](https://pypi.org/project/pwntools) (📥 490K / month · 📦 100 · ⏱️ 12.10.2025):
	```
...
- [GitHub](https://github.com/r0x0r/pywebview) (👨‍💻 190 · 🔀 630 · 📦 4.9K):

	```
	git clone https://github.com/r0x0r/pywebview
	```
- [PyPi](https://pypi.org/project/pywebview) (📥 1.9M / month · 📦 490 · ⏱️ 15.04.2026):
	```
	pip install pywebview
	```
</details>
<details><summary><b><a href="https://github.com/ethereum/web3.py">web3.py</a></b> (🥈28 ·  ⭐ 5.5K) - web3: A Python library for interacting with Ethereum. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub]() (👨‍💻 310 · 🔀 1.7K):
	...
	```
- [PyPi](https://pypi.org/project/web3) (📥 6.4M / month · 📦 2.2K · ⏱️ 01.05.2026):
	```
	pip install web3
	```
...
- [GitHub](https://github.com/aiortc/aiortc) (👨‍💻 41 · 🔀 880 · 📦 6.9K):
...
- [GitHub](https://github.com/netaddr/netaddr) (👨‍💻 54 · 🔀 180 · 📦 43K):
	...
	```
- [PyPi](https://pypi.org/project/netaddr) (📥 14M / month · 📦 730 · ⏱️ 28.05.2024):
	```
	pip install netaddr
	```
...
- [GitHub](https://github.com/jupyter/terminado) (👨‍💻 50 · 🔀 92 · 📦 340K):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 84 · 🔀 160 · 📦 10K):
	...
	```
- [PyPi](https://pypi.org/project/webargs) (📥 3.8M / month · 📦 160 · ⏱️ 29.10.2025):
	```
	pip install webargs
	```
...
<details><summary><b><a href="https://github.com/WeblateOrg/weblate">weblate</a></b> (🥉26 ·  ⭐ 6K) - Web based localization tool with tight version control integration. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/WeblateOrg/weblate) (👨‍💻 2.2K · 🔀 1.3K · 📦 54):

	```
	git clone https://github.com/WeblateOrg/weblate
	```
- [PyPi](https://pypi.org/project/weblate) (📥 170K / month · ⏱️ 07.08.2026):
	```
	pip install weblate
	```
</details>
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 260 · 📦 7.6K):
	...
	```
- [PyPi](https://pypi.org/project/webassets) (📥 300K / month · 📦 98 · ⏱️ 17.08.2025):
	```
...
- [GitHub](https://github.com/alexdlaird/pyngrok) (👨‍💻 33 · 🔀 59 · 📦 12K):
...
- [PyPi](https://pypi.org/project/pyngrok) (📥 2.3M / month · 📦 340 · ⏱️ 29.04.2026):
	...
	pip install pyngrok
	```
- [Conda](https://anaconda.org/conda-forge/pyngrok) (📥 260K · ⏱️ 29.04.2026):
	```
	conda install -c conda-forge pyngrok
	```
</details>
<details><summary><b><a href="https://github.com/fake-useragent/fake-useragent">fake-useragent</a></b> (🥉25 ·  ⭐ 4.1K · 💤) - Up-to-date simple useragent faker with real world.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/fake-useragent) (📥 11M / month · 📦 1.2K · ⏱️ 14.04.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fake-useragent) (📥 94K · ⏱️ 27.08.2025):
	```
...
- [GitHub]() (👨‍💻 36 · 🔀 75):
	...
	```
- [PyPi](https://pypi.org/project/aiodns) (📥 21M / month · 📦 1K · ⏱️ 20.05.2026):
	```
	pip install aiodns
	```
- [Conda](https://anaconda.org/conda-forge/aiodns) (📥 540K · ⏱️ 03.08.2026):
	```
...
- [GitHub](https://github.com/shon/httpagentparser) (👨‍💻 37 · 🔀 57 · 📦 6.3K):
	...
	```
- [PyPi](https://pypi.org/project/httpagentparser) (📥 560K / month · 📦 51 · ⏱️ 08.03.2026):
	```
...
- [GitHub](https://github.com/Kozea/Radicale) (👨‍💻 170 · 🔀 480 · 📦 200):
	...
	```
- [PyPi](https://pypi.org/project/radicale) (📥 56K / month · 📦 43 · ⏱️ 06.08.2026):
	```
...
- [GitHub](https://github.com/siddhantgoel/streaming-form-data) (👨‍💻 22 · 🔀 35 · 📦 210):

	```
	git clone https://github.com/siddhantgoel/streaming-form-data
	```
- [PyPi](https://pypi.org/project/streaming-form-data) (📥 480K / month · 📦 24 · ⏱️ 10.06.2026):
	```
...
- [GitHub](https://github.com/python-trio/trustme) (👨‍💻 25 · 🔀 30 · 📦 1.9K):

	```
	git clone https://github.com/python-trio/trustme
	```
- [PyPi](https://pypi.org/project/trustme) (📥 1.1M / month · 📦 52 · ⏱️ 02.01.2025):
	```
	pip install trustme
	```
- [Conda](https://anaconda.org/conda-forge/trustme) (📥 42K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/nabla-c0d3/sslyze) (👨‍💻 81 · 🔀 490):
	...
	```
- [PyPi](https://pypi.org/project/sslyze) (📥 150K / month · 📦 16 · ⏱️ 29.03.2026):
	```
	pip install sslyze
	```
</details>
<details><summary><b><a href="https://github.com/twisted/klein">klein</a></b> (🥉21 ·  ⭐ 840 · 💤) - werkzeug + twisted.web. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/twisted/klein) (👨‍💻 58 · 🔀 120 · 📦 1.9K):

	```
	git clone https://github.com/twisted/klein
	```
- [PyPi](https://pypi.org/project/klein) (📥 46K / month · 📦 54 · ⏱️ 12.08.2024):
	```
	pip install klein
	```
</details>
...
- [GitHub](https://github.com/pyload/pyload) (👨‍💻 250 · 🔀 750 · 📦 24):

	```
	git clone https://github.com/pyload/pyload
	```
- [PyPi](https://pypi.org/project/pyload-ng) (📥 5.1K / month · 📦 3 · ⏱️ 09.07.2026):
	```
	pip install pyload-ng
	```
</details>
<details><summary><b><a href="https://github.com/thp/urlwatch">urlwatch</a></b> (🥉18 ·  ⭐ 3K) - Watch (parts of) webpages and get notified when something changes via.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/thp/urlwatch) (👨‍💻 97 · 🔀 360 · 📦 27):
...
<details><summary><b><a href="https://github.com/gaojiuli/toapi">toapi</a></b> (🥉15 ·  ⭐ 3.5K) - Every web site provides APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub]() (👨‍💻 12 · 🔀 240 · 📦 21):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 93 / month · ⏱️ 22.05.2026):
	```
	pip install toapi
	```
</details>
...
- <b><a href="https://github.com/pallets/itsdangerous">itsdangerous</a></b> (🥇32 ·  ⭐ 2.9K · 💀) - Safely pass trusted data to untrusted environments and back. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/zeromq/pyzmq">pyzmq</a></b> (🥈31 ·  ⭐ 4K) - PyZMQ: Python bindings for zeromq. <code><a href="https://tldrlegal.com/search?q=Revised%20BSD">❗️Revised BSD</a></code>
...
- <b><a href="https://github.com/kbandla/dpkt">dpkt</a></b> (🥉24 ·  ⭐ 1.1K · 💀) - fast, simple packet creation / parsing, with definitions for the basic.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/phihag/ipaddress">ipaddress</a></b> (🥉24 ·  ⭐ 100 · 💀) - Python 3.3+s ipaddress for older Python versions. <code><a href="http://bit.ly/35wkF7y">Python-2.0</a></code>
- <b><a href="https://github.com/abhinavsingh/proxy.py">proxy.py</a></b> (🥉22 ·  ⭐ 3.2K · 💀) - Ngrok FRP Alternative Fast Lightweight 0 Dependency Pluggable TLS.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/eudicots/Cactus">Cactus</a></b> (🥉21 ·  ⭐ 3.5K · 💀) - Static site generator for designers. Uses Python and Django.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
- <b><a href="https://github.com/joepie91/python-whois">python-whois</a></b> (🥉21 ·  ⭐ 430 · 💤) - A python module for retrieving and parsing WHOIS data. <code><a href="https://tldrlegal.com/search?q=WTFPL">❗️WTFPL</a></code>
- <b><a href="https://github.com/seomoz/reppy">reppy</a></b> (🥉19 ·  ⭐ 200 · 💀) - Modern robots.txt Parser for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/constverum/Proxybroker">ProxyBroker</a></b> (🥉18 ·  ⭐ 3.8K · 💀) - Proxy [Finder | Checker | Server]. HTTP(S) & SOCKS. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
- <b><a href="https://github.com/hyde/hyde">hyde</a></b> (🥉18 ·  ⭐ 1.6K · 💀) - A Python Static Website Generator (See https://duct-ui.org from the.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/jeffknupp/sandman2">sandman2</a></b> (🥉17 ·  ⭐ 1.8K · 💀) - Automatically generate a RESTful API service for your legacy.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
