...
- [GitHub]() (👨‍💻 910 · 🔀 9.7K · 📦 920K):
	...
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 610M / month · 📦 35K · ⏱️ 29.07.2026):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 5.7M · ⏱️ 30.07.2026):
	```
...
- [PyPi](https://pypi.org/project/tornado) (📥 120M / month · 📦 4.2K · ⏱️ 07.08.2026):
	...
	pip install tornado
	```
- [Conda](https://anaconda.org/conda-forge/tornado) (📥 78M · ⏱️ 10.08.2026):
	```
...
- [GitHub]() (👨‍💻 340 · 🔀 1.3K · 📦 440K):
	...
	```
- [PyPi](https://pypi.org/project/starlette) (📥 680M / month · 📦 7.6K · ⏱️ 08.08.2026):
	```
	pip install starlette
	```
- [Conda](https://anaconda.org/conda-forge/starlette) (📥 6.8M · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/encode/django-rest-framework) (👨‍💻 1.5K · 🔀 7.1K · 📦 860K):
	...
	```
- [PyPi](https://pypi.org/project/django-rest-framework) (📥 90K / month · 📦 110 · ⏱️ 20.07.2017):
	```
...
- [GitHub](https://github.com/litestar-org/litestar) (👨‍💻 300 · 🔀 590 · 📦 2.4K):
	...
	```
- [PyPi](https://pypi.org/project/litestar) (📥 2.2M / month · 📦 280 · ⏱️ 11.06.2026):
	```
...
- [GitHub](https://github.com/cherrypy/cherrypy) (👨‍💻 150 · 🔀 370 · 📦 15K):
	...
	```
- [PyPi](https://pypi.org/project/cherrypy) (📥 780K / month · 📦 430 · ⏱️ 14.06.2024):
	```
	pip install cherrypy
	```
- [Conda](https://anaconda.org/anaconda/cherrypy) (📥 35K · ⏱️ 12.12.2025):
	```
...
- [GitHub](https://github.com/dpgaspar/Flask-AppBuilder) (👨‍💻 230 · 🔀 1.4K):
	...
	```
- [PyPi](https://pypi.org/project/flask-appbuilder) (📥 13M / month · 📦 16 · ⏱️ 29.06.2026):
	```
...
- [GitHub](https://github.com/pgjones/quart) (👨‍💻 68 · 🔀 200):
	...
	```
- [PyPi](https://pypi.org/project/quart) (📥 4.2M / month · 📦 320 · ⏱️ 19.08.2026):
	```
	pip install quart
	```
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 220 · 🔀 730 · 📦 1.2K):
	...
	```
- [PyPi](https://pypi.org/project/eve) (📥 28K / month · 📦 46 · ⏱️ 24.03.2026):
	```
	pip install eve
	```
</details>
...
- [GitHub]() (👨‍💻 91 · 🔀 330 · 📦 260):
	...
	```
- [PyPi](https://pypi.org/project/robyn) (📥 18K / month · 📦 20 · ⏱️ 25.06.2026):
	```
	pip install robyn
	```
...
- [GitHub](https://github.com/webpy/webpy) (👨‍💻 98 · 🔀 1.3K · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/web.py) (📥 75K / month · 📦 53 · ⏱️ 09.11.2020):
	```
	pip install web.py
	```
...
- [GitHub]() (👨‍💻 87 · 🔀 220 · 📦 600):
	...
	```
- [PyPi](https://pypi.org/project/responder) (📥 8.9K / month · 📦 15 · ⏱️ 14.07.2026):
	```
...
- [GitHub](https://github.com/plone/guillotina) (👨‍💻 54 · 🔀 53 · 📦 140):
	...
	```
- [PyPi](https://pypi.org/project/guillotina) (📥 1.7K / month · 📦 38 · ⏱️ 24.06.2026):
	```
...
- [GitHub](https://github.com/emmett-framework/emmett) (👨‍💻 25 · 🔀 73 · 📦 95):
	...
	```
- [PyPi](https://pypi.org/project/emmett) (📥 300 / month · 📦 8 · ⏱️ 07.04.2026):
	```
	pip install emmett
	```
</details>
...
- [PyPi](https://pypi.org/project/requests) (📥 1.8B / month · 📦 170K · ⏱️ 14.05.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 92M · ⏱️ 15.05.2026):
	```
...
- [PyPi](https://pypi.org/project/urllib3) (📥 1.9B / month · 📦 25K · ⏱️ 07.05.2026):
	...
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 100M · ⏱️ 07.05.2026):
	```
...
- [GitHub](https://github.com/aio-libs/aiohttp) (👨‍💻 990 · 🔀 2.4K · 📦 810K):
	...
	```
- [PyPi](https://pypi.org/project/aiohttp) (📥 670M / month · 📦 33K · ⏱️ 23.07.2026):
	```
	pip install aiohttp
	```
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 250 · 🔀 1.3K · 📦 670K):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 860M / month · 📦 72K · ⏱️ 19.08.2026):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 23M · ⏱️ 22.04.2025):
	```
...
- [PyPi](https://pypi.org/project/httptools) (📥 270M / month · 📦 590 · ⏱️ 25.05.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/httptools) (📥 4.7M · ⏱️ 26.05.2026):
	```
...
- [GitHub](https://github.com/encode/httpcore) (👨‍💻 59 · 🔀 170 · 📦 440K):
	...
	```
- [PyPi](https://pypi.org/project/httpcore) (📥 850M / month · 📦 970 · ⏱️ 24.04.2025):
	```
...
- [PyPi](https://pypi.org/project/httplib2) (📥 180M / month · 📦 1.2K · ⏱️ 26.06.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 5.7M · ⏱️ 26.06.2026):
	```
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 59 · 🔀 140 · 📦 1.8K):
	...
	```
- [PyPi](https://pypi.org/project/treq) (📥 250K / month · 📦 130 · ⏱️ 02.07.2026):
	```
	pip install treq
	```
...
- [GitHub](https://github.com/reorx/httpstat) (👨‍💻 6 · 🔀 380 · 📦 20):
	...
	```
- [PyPi](https://pypi.org/project/httpstat) (📥 1.4K / month · ⏱️ 08.04.2026):
	```
...
- <b><a href="https://github.com/httpie/http-prompt">http-prompt</a></b> (🥉20 ·  ⭐ 9.1K · 💀) - An interactive command-line HTTP and API testing client built on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub]() (👨‍💻 220 · 🔀 1K · 📦 920K):
	...
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 680M / month · 📦 23K · ⏱️ 19.08.2026):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 7.9M · ⏱️ 19.08.2026):
	```
...
- [GitHub](https://github.com/django/asgiref) (👨‍💻 120 · 🔀 250 · 📦 1.2M):
...
- [GitHub](https://github.com/gevent/gevent) (👨‍💻 130 · 🔀 960 · 📦 150K):
	...
	```
- [PyPi](https://pypi.org/project/gevent) (📥 51M / month · 📦 2.4K · ⏱️ 10.08.2026):
	```
	pip install gevent
	```
...
- [GitHub](https://github.com/pgjones/hypercorn) (👨‍💻 73 · 🔀 140 · 📦 13K):
	...
	```
- [PyPi](https://pypi.org/project/hypercorn) (📥 7.7M / month · 📦 160 · ⏱️ 08.11.2025):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 190 · 📦 850):
	...
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 51K / month · 📦 67 · ⏱️ 19.09.2022):
	```
	pip install bjoern
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 160 · 🔀 760 · 📦 830K):
	...
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 720M / month · 📦 9K · ⏱️ 21.05.2026):
	```
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 27M · ⏱️ 21.05.2026):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 810 · 🔀 3.1K · 📦 270K):
	...
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 5.1M / month · 📦 320 · ⏱️ 13.08.2026):
	```
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 340M / month · 📦 1.7K · ⏱️ 19.06.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 19M · ⏱️ 20.06.2025):
	```
...
- [GitHub](https://github.com/pyauth/pyotp) (👨‍💻 53 · 🔀 350 · 📦 28K):
	...
	```
- [PyPi](https://pypi.org/project/pyotp) (📥 42M / month · 📦 460 · ⏱️ 27.07.2023):
	```
	pip install pyotp
	```
...
- [GitHub]() (👨‍💻 150 · 🔀 550 · 📦 56K):
	...
	```
- [PyPi](https://pypi.org/project/authlib) (📥 160M / month · 📦 1.6K · ⏱️ 06.05.2026):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/iMerica/dj-rest-auth) (👨‍💻 210 · 🔀 340 · 📦 68K):
	...
	```
- [PyPi](https://pypi.org/project/dj-rest-auth) (📥 800K / month · 📦 26 · ⏱️ 15.03.2026):
	```
	pip install dj-rest-auth
	```
- [Conda](https://anaconda.org/conda-forge/dj-rest-auth) (📥 65K · ⏱️ 16.03.2026):
	```
...
- [PyPi](https://pypi.org/project/flask-jwt-extended) (📥 12M / month · 📦 380 · ⏱️ 13.05.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-jwt-extended) (📥 470K · ⏱️ 14.05.2026):
	```
...
- [GitHub](https://github.com/sunscrapers/djoser) (👨‍💻 110 · 🔀 470 · 📦 36K):
	...
	```
- [PyPi](https://pypi.org/project/djoser) (📥 390K / month · 📦 14 · ⏱️ 01.08.2026):
	```
	pip install djoser
	```
</details>
...
- [GitHub](https://github.com/jazzband/djangorestframework-simplejwt) (👨‍💻 140 · 🔀 710):
	...
	```
- [PyPi](https://pypi.org/project/djangorestframework-simplejwt) (📥 8.2M / month · 📦 310 · ⏱️ 21.07.2025):
	```
...
- [GitHub]() (👨‍💻 64 · 🔀 230 · 📦 12K):
	...
	```
- [PyPi](https://pypi.org/project/django-rest-knox) (📥 820K / month · 📦 46 · ⏱️ 12.07.2026):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 34 · 🔀 150):
	...
	```
- [PyPi](https://pypi.org/project/rules) (📥 560K / month · 📦 56 · ⏱️ 02.09.2024):
	```
	pip install rules
	```
</details>
...
- [GitHub](https://github.com/dusktreader/flask-praetorian) (👨‍💻 27 · 🔀 47 · 📦 460):
	...
	```
- [PyPi](https://pypi.org/project/flask-praetorian) (📥 6.1K / month · 📦 2 · ⏱️ 19.08.2025):
	```
...
- [GitHub](https://github.com/authomatic/authomatic) (👨‍💻 49 · 🔀 390):
	...
	```
- [PyPi](https://pypi.org/project/authomatic) (📥 6.5K / month · 📦 10 · ⏱️ 28.05.2024):
	```
...
- <b><a href="https://django-oauth-toolkit.readthedocs.io/">django-oauth-toolkit</a></b> (🥈26 ·  ⭐ 3.3K) - OAuth2 Provider for Django. <code>❗Unlicensed</code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/lxml/lxml) (👨‍💻 180 · 🔀 640 · 📦 620K):

	```
	git clone https://github.com/lxml/lxml
	```
- [PyPi](https://pypi.org/project/lxml) (📥 410M / month · 📦 22K · ⏱️ 19.08.2026):
	```
	pip install lxml
	```
- [Conda](https://anaconda.org/conda-forge/lxml) (📥 23M · ⏱️ 19.08.2026):
	```
	conda install -c conda-forge lxml
	```
</details>
<details><summary><b><a href="https://github.com/Kozea/WeasyPrint">WeasyPrint</a></b> (🥈32 ·  ⭐ 9.5K) - The awesome document factory. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Kozea/WeasyPrint) (👨‍💻 190 · 🔀 860 · 📦 31K):

	```
	git clone https://github.com/Kozea/WeasyPrint
	```
- [PyPi](https://pypi.org/project/weasyprint) (📥 39M / month · 📦 1.4K · ⏱️ 02.06.2026):
	```
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 51 · 🔀 180 · 📦 2.2M):
	...
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 840M / month · 📦 5.3K · ⏱️ 27.09.2025):
	```
	pip install markupsafe
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 84M · ⏱️ 02.03.2026):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 79 · 🔀 260):
	...
	```
- [PyPi](https://pypi.org/project/bleach) (📥 76M / month · 📦 2.1K · ⏱️ 05.06.2026):
	```
	pip install bleach
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 54 · 🔀 180 · 📦 28K):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 2.4M / month · 📦 600 · ⏱️ 27.07.2026):
	```
	pip install pyquery
	```
...
- [GitHub](https://github.com/rushter/selectolax) (👨‍💻 26 · 🔀 91 · 📦 3.4K):
	...
	```
- [PyPi](https://pypi.org/project/selectolax) (📥 5.9M / month · 📦 470 · ⏱️ 15.07.2026):
	```
...
- [GitHub](https://github.com/john-kurkowski/tldextract) (👨‍💻 56 · 🔀 220 · 📦 45K):
	...
	```
- [PyPi](https://pypi.org/project/tldextract) (📥 39M / month · 📦 1.1K · ⏱️ 08.08.2026):
	```
	pip install tldextract
	```
- [Conda](https://anaconda.org/conda-forge/tldextract) (📥 920K · ⏱️ 09.08.2026):
	```
...
- [GitHub](https://github.com/aio-libs/yarl) (👨‍💻 140 · 🔀 200):
	...
	```
- [PyPi](https://pypi.org/project/yarl) (📥 650M / month · 📦 3.5K · ⏱️ 20.07.2026):
	```
	pip install yarl
	```
...
- [GitHub](https://github.com/python-hyper/uritemplate) (👨‍💻 22 · 🔀 39):
	...
	```
- [PyPi](https://pypi.org/project/uritemplate) (📥 190M / month · 📦 570 · ⏱️ 02.06.2025):
	```
	pip install uritemplate
	```
- [Conda](https://anaconda.org/conda-forge/uritemplate) (📥 8.3M · ⏱️ 02.06.2025):
	```
...
- [PyPi](https://pypi.org/project/openapi-generator-cli) (📥 710K / month · 📦 25 · ⏱️ 21.07.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@openapitools/openapi-generator-cli) (📥 6.4M / month · 📦 1.5K · ⏱️ 24.07.2026):
	```
...
- [PyPi](https://pypi.org/project/drf-spectacular) (📥 14M / month · 📦 420 · ⏱️ 06.07.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/drf-spectacular) (📥 99K · ⏱️ 06.07.2026):
	```
...
- [GitHub](https://github.com/koxudaxi/datamodel-code-generator) (👨‍💻 240 · 🔀 450 · 📦 3.9K):
	...
	```
- [PyPi](https://pypi.org/project/datamodel-code-generator) (📥 18M / month · 📦 630 · ⏱️ 17.08.2026):
	```
...
- [GitHub](https://github.com/marshmallow-code/apispec) (👨‍💻 97 · 🔀 190 · 📦 20K):
	...
	```
- [PyPi](https://pypi.org/project/apispec) (📥 13M / month · 📦 390 · ⏱️ 06.03.2026):
	```
	pip install apispec
	```
...
- [GitHub]() (👨‍💻 46 · 🔀 73 · 📦 12K):
	...
	```
- [PyPi](https://pypi.org/project/openapi-spec-validator) (📥 44M / month · 📦 440 · ⏱️ 20.05.2026):
	```
...
- [PyPi](https://pypi.org/project/openapi-core) (📥 4M / month · 📦 130 · ⏱️ 02.04.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/openapi-core) (📥 75K · ⏱️ 03.04.2026):
	```
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 410 · 📦 790):
	...
	```
- [PyPi](https://pypi.org/project/apistar) (📥 8.4K / month · 📦 55 · ⏱️ 30.11.2023):
	```
	pip install apistar
	```
...
- [GitHub](https://github.com/graphql-python/graphql-core) (👨‍💻 45 · 🔀 150 · 📦 43K):
	...
	```
- [PyPi](https://pypi.org/project/graphql-core) (📥 81M / month · 📦 630 · ⏱️ 19.06.2026):
	```
...
- [GitHub](https://github.com/mirumee/ariadne) (👨‍💻 88 · 🔀 200 · 📦 2.1K):
	...
	```
- [PyPi](https://pypi.org/project/ariadne) (📥 2M / month · 📦 100 · ⏱️ 15.06.2026):
	```
	pip install ariadne
	```
</details>
...
- [GitHub]() (👨‍💻 89 · 🔀 600 · 📦 400K):
	...
	```
- [PyPi](https://pypi.org/project/websockets) (📥 590M / month · 📦 13K · ⏱️ 31.07.2026):
	```
	pip install websockets
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 8.4M · ⏱️ 02.08.2026):
	```
...
- [GitHub](https://github.com/websocket-client/websocket-client) (👨‍💻 230 · 🔀 780 · 📦 340K):
...
- [GitHub](https://github.com/miguelgrinberg/python-socketio) (👨‍💻 86 · 🔀 620 · 📦 71K):
	...
	```
- [PyPi](https://pypi.org/project/python-socketio) (📥 30M / month · 📦 1.2K · ⏱️ 06.08.2026):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 79 · 🔀 290 · 📦 41K):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 6.4M / month · 📦 210 · ⏱️ 21.07.2026):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 240K · ⏱️ 21.07.2026):
	```
	conda install -c conda-forge daphne
	```
</details>
<details><summary><b><a href="https://github.com/miguelgrinberg/Flask-SocketIO">Flask-SocketIO</a></b> (🥈28 ·  ⭐ 5.5K · 📉) - Socket.IO integration for Flask applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/miguelgrinberg/Flask-SocketIO) (👨‍💻 72 · 🔀 900 · 📦 62K):
...
- [PyPi](https://pypi.org/project/httpx-ws) (📥 12M / month · 📦 110 · ⏱️ 28.03.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/httpx-ws) (📥 60K · ⏱️ 28.03.2026):
	```
...
- [GitHub](https://github.com/grpc/grpc) (👨‍💻 1.2K · 🔀 11K · 📦 7.4K):

	```
	git clone https://github.com/grpc/grpc
	```
- [PyPi](https://pypi.org/project/grpcio) (📥 460M / month · 📦 6.8K · ⏱️ 23.07.2026):
	```
	pip install grpcio
	```
...
- [GitHub](https://github.com/tomerfiliba-org/rpyc) (👨‍💻 86 · 🔀 250 · 📦 3.5K):
...
- [GitHub](https://github.com/smagafurov/fastapi-jsonrpc) (👨‍💻 17 · 🔀 37 · 📦 83):
	...
	```
- [PyPi](https://pypi.org/project/fastapi-jsonrpc) (📥 29K / month · 📦 10 · ⏱️ 17.04.2026):
	```
...
- [GitHub](https://github.com/unum-cloud/ucall) (👨‍💻 14 · 🔀 54 · 📦 63):
	...
	```
- [PyPi](https://pypi.org/project/ucall) (📥 890 / month · 📦 1 · ⏱️ 15.04.2024):
	```
	pip install ucall
	```
</details>
...
- [GitHub](https://github.com/aws/chalice) (👨‍💻 210 · 🔀 1K · 📦 3.3K):
	...
	```
- [PyPi](https://pypi.org/project/chalice) (📥 980K / month · 📦 70 · ⏱️ 07.05.2026):
	```
	pip install chalice
	```
- [Conda](https://anaconda.org/conda-forge/chalice) (📥 640K · ⏱️ 07.05.2026):
	```
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/zappa) (📥 260K / month · 📦 20 · ⏱️ 11.03.2026):
	```
	pip install zappa
	```
</details>
...
- [GitHub](https://github.com/wagtail/wagtail) (👨‍💻 1.1K · 🔀 4.6K · 📦 12K):
	...
	```
- [PyPi](https://pypi.org/project/wagtail) (📥 1.1M / month · 📦 920 · ⏱️ 20.08.2026):
	```
	pip install wagtail
	```
...
- [GitHub](https://github.com/django-cms/django-cms) (👨‍💻 600 · 🔀 3.2K · 📦 5.5K):
	...
	```
- [PyPi](https://pypi.org/project/django-cms) (📥 120K / month · 📦 370 · ⏱️ 06.08.2026):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 100 · 🔀 320 · 📦 500):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 7.1K / month · 📦 41 · ⏱️ 07.08.2026):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 240):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 7.2K / month · 📦 15 · ⏱️ 11.02.2026):
	```
	pip install feincms
	```
</details>
...
- [GitHub](https://github.com/SeleniumHQ/selenium) (👨‍💻 940 · 🔀 8.7K · 📦 430K):

	```
	git clone https://github.com/SeleniumHQ/selenium
	```
- [PyPi](https://pypi.org/project/selenium) (📥 57M / month · 📦 8K · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 400 · 🔀 3.2K · 📦 18K):
	...
	```
- [PyPi](https://pypi.org/project/locust) (📥 14M / month · 📦 330 · ⏱️ 20.08.2026):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 380K · ⏱️ 01.08.2026):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 150 · 🔀 370 · 📦 55K):
	...
	```
- [PyPi](https://pypi.org/project/responses) (📥 71M / month · 📦 3.8K · ⏱️ 03.07.2026):
	```
	pip install responses
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 3.9M · ⏱️ 03.07.2026):
	```
...
- [GitHub](https://github.com/seleniumbase/SeleniumBase) (👨‍💻 40 · 🔀 1.6K · 📦 2.8K):
	...
	```
- [PyPi](https://pypi.org/project/seleniumbase) (📥 3M / month · 📦 130 · ⏱️ 19.08.2026):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 85 · 🔀 220 · 📦 1.1K):
	...
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 6.3M / month · 📦 94 · ⏱️ 25.07.2026):
	```
...
- [GitHub](https://github.com/stoplightio/prism) (👨‍💻 110 · 🔀 410 · 📦 830):
	...
	```
- [npm](https://www.npmjs.com/package/@stoplight/prism-cli) (📥 780K / month · 📦 99 · ⏱️ 17.07.2026):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 510 · 📦 7.2K):
	...
	```
- [PyPi](https://pypi.org/project/splinter) (📥 440K / month · 📦 55 · ⏱️ 16.01.2024):
	```
...
- [GitHub](https://github.com/taverntesting/tavern) (👨‍💻 70 · 🔀 200 · 📦 910):
	...
	```
- [PyPi](https://pypi.org/project/tavern) (📥 240K / month · 📦 15 · ⏱️ 14.06.2026):
	```
	pip install tavern
	```
</details>
...
- [GitHub](https://github.com/pnuckowski/aioresponses) (👨‍💻 60 · 🔀 100):
	...
	```
- [PyPi](https://pypi.org/project/aioresponses) (📥 7.5M / month · 📦 880 · ⏱️ 23.06.2026):
	```
...
- [GitHub](https://github.com/model-bakers/model_bakery) (👨‍💻 70 · 🔀 110):
	...
	```
- [PyPi](https://pypi.org/project/model_bakery) (📥 2.2M / month · 📦 120 · ⏱️ 23.06.2026):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-flask) (👨‍💻 39 · 🔀 89):
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 34 · 🔀 51):
	...
	```
- [PyPi](https://pypi.org/project/mocket) (📥 280K / month · 📦 15 · ⏱️ 13.07.2026):
	```
	pip install mocket
	```
</details>
<details><summary><b><a href="https://github.com/httprunner/httprunner">httprunner</a></b> (🥉20 ·  ⭐ 4.3K · 💤) - HttpRunner API/UI. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/Pylons/pyramid_debugtoolbar) (👨‍💻 71 · 🔀 83):
	...
	```
- [PyPi](https://pypi.org/project/pyramid_debugtoolbar) (📥 1.7M / month · 📦 46 · ⏱️ 05.02.2024):
	```
...
- [GitHub](https://github.com/fsociety-team/fsociety) (👨‍💻 12 · 🔀 190 · 📦 17):
...
- <b><a href="https://github.com/pytest-dev/pytest-splinter">pytest-splinter</a></b> (🥉21 ·  ⭐ 250 · 💀) - pytest splinter and selenium integration for anyone.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/jazzband/django-formtools) (👨‍💻 79 · 🔀 140 · 📦 12K):
	...
	```
- [PyPi](https://pypi.org/project/django-formtools) (📥 3.9M / month · 📦 100 · ⏱️ 09.07.2026):
	```
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 850):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 45K / month · 📦 30 · ⏱️ 26.02.2026):
	```
	pip install deform
	```
</details>
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 66 · 🔀 290 · 📦 380K):

	```
	git clone https://github.com/lepture/mistune
	```
- [PyPi](https://pypi.org/project/mistune) (📥 78M / month · 📦 1.7K · ⏱️ 22.07.2026):
	```
	pip install mistune
	```
...
- [GitHub](https://github.com/executablebooks/markdown-it-py) (👨‍💻 35 · 🔀 100 · 📦 390K):
	...
	```
- [PyPi](https://pypi.org/project/markdown-it-py) (📥 640M / month · 📦 2.7K · ⏱️ 07.05.2026):
	```
...
- [PyPi](https://pypi.org/project/pymdown-extensions) (📥 26M / month · 📦 2.7K · ⏱️ 02.07.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pymdown-extensions) (📥 870K · ⏱️ 02.07.2026):
	```
...
- [GitHub](https://github.com/agusmakmun/django-markdown-editor) (👨‍💻 46 · 🔀 1.3K · 📦 1.2K):
	...
	```
- [PyPi](https://pypi.org/project/martor) (📥 63K / month · 📦 22 · ⏱️ 22.06.2026):
	```
	pip install martor
	```
</details>
...
- <b><a href="https://github.com/joeyespo/grip">grip</a></b> (🥉24 ·  ⭐ 6.4K · 💀) - Preview GitHub README.md files locally before committing them. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/gitpython-developers/GitPython) (👨‍💻 390 · 🔀 990 · 📦 430K):
	...
	```
- [PyPi](https://pypi.org/project/gitpython) (📥 270M / month · 📦 10K · ⏱️ 10.08.2026):
	```
	pip install gitpython
	```
- [Conda](https://anaconda.org/conda-forge/gitpython) (📥 19M · ⏱️ 11.08.2026):
	```
...
- [GitHub](https://github.com/tweepy/tweepy) (👨‍💻 250 · 🔀 4.5K · 📦 66K):
	...
	```
- [PyPi](https://pypi.org/project/tweepy) (📥 5M / month · 📦 630 · ⏱️ 02.07.2026):
	```
	pip install tweepy
	```
...
- [GitHub](https://github.com/PyGithub/PyGithub) (👨‍💻 440 · 🔀 1.9K · 📦 75K):

	```
	git clone https://github.com/PyGithub/PyGithub
	```
- [PyPi](https://pypi.org/project/pygithub) (📥 76M / month · 📦 3.1K · ⏱️ 20.08.2026):
	```
	pip install pygithub
	```
- [Conda](https://anaconda.org/conda-forge/pygithub) (📥 9.3M · ⏱️ 20.08.2026):
	```
...
- [GitHub](https://github.com/Rapptz/discord.py) (👨‍💻 460 · 🔀 3.9K · 📦 55K):
	...
	```
- [PyPi](https://pypi.org/project/discord.py) (📥 7.6M / month · 📦 1.3K · ⏱️ 03.03.2026):
	```
...
- [GitHub](https://github.com/eternnoir/pyTelegramBotAPI) (👨‍💻 270 · 🔀 2.2K · 📦 65K):
	...
	```
- [PyPi](https://pypi.org/project/pytelegrambotapi) (📥 1.5M / month · 📦 360 · ⏱️ 13.08.2026):
	```
...
- [GitHub](https://github.com/LonamiWebs/Telethon) (👨‍💻 210 · 🔀 1.6K · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/telethon) (📥 4.1M / month · 📦 710 · ⏱️ 15.06.2026):
	```
...
- [GitHub](https://github.com/praw-dev/praw) (👨‍💻 240 · 🔀 500 · 📦 28K):
	...
	```
- [PyPi](https://pypi.org/project/praw) (📥 2M / month · 📦 440 · ⏱️ 12.08.2026):
	```
	pip install praw
	```
- [Conda](https://anaconda.org/conda-forge/praw) (📥 110K · ⏱️ 26.06.2026):
	```
...
- [GitHub](https://github.com/slackapi/python-slack-sdk) (👨‍💻 190 · 🔀 860):
	...
	```
- [PyPi](https://pypi.org/project/slack-sdk) (📥 100M / month · 📦 1.3K · ⏱️ 30.06.2026):
	```
	pip install slack-sdk
	```
- [Conda](https://anaconda.org/conda-forge/slack-sdk) (📥 950K · ⏱️ 01.07.2026):
	```
...
- [GitHub](https://github.com/twilio/twilio-python) (👨‍💻 150 · 🔀 810 · 📦 60K):
	...
	```
- [PyPi](https://pypi.org/project/twilio) (📥 22M / month · 📦 690 · ⏱️ 11.08.2026):
	```
	pip install twilio
	```
- [Conda](https://anaconda.org/conda-forge/twilio) (📥 460K · ⏱️ 12.08.2026):
	```
...
- [GitHub](https://github.com/stripe/stripe-python) (👨‍💻 360 · 🔀 530):
	...
	```
- [PyPi](https://pypi.org/project/stripe) (📥 43M / month · 📦 770 · ⏱️ 19.08.2026):
	```
	pip install stripe
	```
- [Conda](https://anaconda.org/anaconda/stripe) (📥 48K · ⏱️ 11.06.2026):
	```
...
- [GitHub](https://github.com/waditu/tushare) (👨‍💻 34 · 🔀 4.4K · 📦 2.7K):
	...
	```
- [PyPi](https://pypi.org/project/tushare) (📥 520K / month · 📦 170 · ⏱️ 25.03.2026):
	```
	pip install tushare
	```
</details>
...
- [GitHub]() (👨‍💻 200 · 🔀 970 · 📦 44K):
	...
	```
- [PyPi](https://pypi.org/project/spotipy) (📥 470K / month · 📦 510 · ⏱️ 03.03.2026):
	```
	pip install spotipy
	```
...
- [PyPi](https://pypi.org/project/jira) (📥 24M / month · 📦 450 · ⏱️ 28.07.2025):
	...
	pip install jira
	```
- [Conda](https://anaconda.org/conda-forge/jira) (📥 300K · ⏱️ 28.07.2025):
	```
...
- [GitHub](https://github.com/mikf/gallery-dl) (👨‍💻 210 · 🔀 1.4K · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/gallery-dl) (📥 410K / month · 📦 38 · ⏱️ 01.08.2026):
	```
...
- [GitHub](https://github.com/ramnes/notion-sdk-py) (👨‍💻 44 · 🔀 170):
	...
	```
- [PyPi](https://pypi.org/project/notion-client) (📥 4.7M / month · 📦 290 · ⏱️ 12.05.2026):
	```
...
- [GitHub]() (👨‍💻 23 · 🔀 70 · 📦 3.6K):
	...
	```
- [PyPi](https://pypi.org/project/ghapi) (📥 440M / month · 📦 170 · ⏱️ 13.08.2026):
	```
	pip install ghapi
	```
</details>
...
- [GitHub](https://github.com/wechatpy/wechatpy) (👨‍💻 100 · 🔀 820 · 📦 10K):
...
<details><summary><b><a href="https://github.com/ssut/py-googletrans">py-googletrans</a></b> (🥉24 ·  ⭐ 4.3K · 📉) - (unofficial) Googletrans: Free and Unlimited Google.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ssut/py-googletrans) (👨‍💻 31 · 🔀 740):
	...
	```
- [PyPi](https://pypi.org/project/googletrans) (📥 2.7M / month · 📦 400 · ⏱️ 01.01.2025):
	```
...
- [GitHub](https://github.com/jamalex/notion-py) (👨‍💻 36 · 🔀 470):
	...
	```
- [PyPi](https://pypi.org/project/notion) (📥 900K / month · 📦 61 · ⏱️ 16.02.2026):
	```
	pip install notion
	```
</details>
...
- [GitHub](https://github.com/hardikvasa/google-images-download) (👨‍💻 41 · 🔀 2.1K):
	...
	```
- [PyPi](https://pypi.org/project/google_images_download) (📥 2.8K / month · 📦 3 · ⏱️ 21.05.2019):
	```
	pip install google_images_download
	```
</details>
<details><summary><b><a href="https://github.com/scdl-org/scdl">scdl</a></b> (🥉20 ·  ⭐ 4.1K) - Download Music from Souncloud. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub]() (👨‍💻 53 · 🔀 400 · 📦 430):
	...
	```
- [PyPi](https://pypi.org/project/scdl) (📥 3.2K / month · 📦 5 · ⏱️ 20.08.2026):
	```
	pip install scdl
	```
</details>
...
- [GitHub]() (👨‍💻 41 · 🔀 1K · 📦 460):
	...
	```
- [PyPi](https://pypi.org/project/wikiextractor) (📥 5.5K / month · 📦 10 · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/sabuhish/fastapi-mail) (👨‍💻 56 · 🔀 110 · 📦 5.8K):
	...
	```
- [PyPi](https://pypi.org/project/fastapi-mail) (📥 3.7M / month · 📦 36 · ⏱️ 18.06.2026):
	```
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 34 · 🔀 270 · 📦 5.8K):
	...
	```
- [PyPi](https://pypi.org/project/yagmail) (📥 340K / month · 📦 170 · ⏱️ 26.05.2026):
	```
	pip install yagmail
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 130 · 🔀 480 · 📦 62):
	...
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 4.1K / month · 📦 15 · ⏱️ 05.08.2026):
	```
	pip install modoboa
	```
</details>
...
- [GitHub](https://github.com/nylas/sync-engine) (👨‍💻 80 · 🔀 350):
	...
	```
- [PyPi](https://pypi.org/project/nylas) (📥 440K / month · 📦 10 · ⏱️ 21.07.2026):
	```
	pip install nylas
	```
</details>
...
- [GitHub](https://github.com/scrapy/scrapy) (👨‍💻 740 · 🔀 12K · 📦 56K):
	...
	```
- [PyPi](https://pypi.org/project/scrapy) (📥 3.9M / month · 📦 1.1K · ⏱️ 20.08.2026):
	```
	pip install scrapy
	```
...
<details><summary><b><a href="https://github.com/kurtmckee/feedparser">feedparser</a></b> (🥇32 ·  ⭐ 2.4K) - Parse feeds in Python. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/kurtmckee/feedparser) (👨‍💻 63 · 🔀 370 · 📦 100K):
	...
	```
- [PyPi](https://pypi.org/project/feedparser) (📥 26M / month · 📦 2.1K · ⏱️ 30.07.2026):
	```
	pip install feedparser
	```
- [Conda](https://anaconda.org/conda-forge/feedparser) (📥 4M · ⏱️ 08.08.2026):
	```
...
- [PyPi](https://pypi.org/project/soupsieve) (📥 460M / month · 📦 2K · ⏱️ 07.08.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/soupsieve) (📥 40M · ⏱️ 08.08.2026):
	```
...
- [GitHub](https://github.com/adbar/trafilatura) (👨‍💻 71 · 🔀 400 · 📦 10K):
...
- [GitHub](https://github.com/scrapy/parsel) (👨‍💻 55 · 🔀 160 · 📦 40K):
	...
	```
- [PyPi](https://pypi.org/project/parsel) (📥 4.8M / month · 📦 410 · ⏱️ 29.01.2026):
	```
	pip install parsel
	```
...
- [GitHub](https://github.com/maurosoria/dirsearch) (👨‍💻 110 · 🔀 2.4K · 📦 200):
	...
	```
- [PyPi](https://pypi.org/project/dirsearch) (📥 32K / month · 📦 1 · ⏱️ 19.08.2026):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 29 · 🔀 89 · 📦 3.2K):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 230K / month · 📦 26 · ⏱️ 05.07.2026):
	```
...
- [GitHub](https://github.com/grangier/python-goose) (👨‍💻 36 · 🔀 830):
	...
	```
- [PyPi](https://pypi.org/project/goose3) (📥 86K / month · 📦 33 · ⏱️ 23.07.2026):
	```
	pip install goose3
	```
</details>
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 59 · 🔀 380):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 150K / month · 📦 120 · ⏱️ 30.05.2025):
	```
...
- [GitHub](https://github.com/Iploop/proxyclaw) (👨‍💻 3):
	...
	```
- [PyPi](https://pypi.org/project/iploop-sdk) (📥 61 / month · 📦 3 · ⏱️ 30.04.2026):
	```
...
- [PyPi](https://pypi.org/project/sentry) (📥 2.5K / month · 📦 140 · ⏱️ 25.07.2023):
	...
	pip install sentry
	```
- [Conda](https://anaconda.org/conda-forge/sentry-sdk) (📥 1.9M · ⏱️ 13.08.2026):
	```
...
- [PyPi](https://pypi.org/project/timing-asgi) (📥 640K / month · 📦 9 · ⏱️ 17.02.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/opentelemetry-api) (📥 4.7M · ⏱️ 16.07.2026):
	```
...
- [GitHub](https://github.com/tomwojcik/starlette-context) (👨‍💻 11 · 🔀 29 · 📦 1.6K):
	...
	```
- [PyPi](https://pypi.org/project/starlette-context) (📥 2.2M / month · 📦 93 · ⏱️ 28.02.2026):
	```
...
- [GitHub](https://github.com/streamlit/streamlit) (👨‍💻 1K · 🔀 4.4K · 📦 1M):
	...
	```
- [PyPi](https://pypi.org/project/streamlit) (📥 31M / month · 📦 7.2K · ⏱️ 19.08.2026):
	```
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 260 · 🔀 620 · 📦 19K):
	...
	```
- [PyPi](https://pypi.org/project/panel) (📥 3.6M / month · 📦 710 · ⏱️ 19.08.2026):
	```
	pip install panel
	```
</details>
...
- [PyPi](https://pypi.org/project/nicegui) (📥 1.2M / month · 📦 520 · ⏱️ 12.08.2026):
	...
	pip install nicegui
	```
- [Conda](https://anaconda.org/conda-forge/nicegui) (📥 170K · ⏱️ 14.08.2026):
	```
	conda install -c conda-forge nicegui
	```
- [Docker Hub](https://hub.docker.com/r/zauberzeug/nicegui) (📥 91K · ⭐ 12 · ⏱️ 12.08.2026):
	```
...
- [GitHub](https://github.com/Kitware/trame) (👨‍💻 32 · 🔀 80 · 📦 820):
	...
	```
- [PyPi](https://pypi.org/project/trame) (📥 1.3M / month · 📦 190 · ⏱️ 15.05.2026):
	```
	pip install trame
	```
</details>
...
- [GitHub](https://github.com/h2oai/wave) (👨‍💻 65 · 🔀 370):
	...
	```
- [PyPi](https://pypi.org/project/wave) (📥 59K / month · 📦 120 · ⏱️ 15.03.2024):
	```
	pip install wave
	```
</details>
...
- [GitHub](https://github.com/wooey/wooey) (👨‍💻 25 · 🔀 190 · 📦 52):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 170 / month · ⏱️ 13.04.2026):
	```
	pip install wooey
	```
</details>
...
- [GitHub]() (👨‍💻 330 · 🔀 1.1K · 📦 110K):
	...
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 9.3M / month · 📦 400 · ⏱️ 14.08.2026):
	```
	pip install django-debug-toolbar
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 680K · ⏱️ 16.08.2026):
	```
...
- [GitHub]() (👨‍💻 390 · 🔀 1.6K · 📦 33K):
	...
	```
- [PyPi](https://pypi.org/project/flask-admin) (📥 2.6M / month · 📦 210 · ⏱️ 07.05.2026):
	```
	pip install flask-admin
	```
- [Conda](https://anaconda.org/conda-forge/flask-admin) (📥 480K · ⏱️ 07.05.2026):
	```
...
- [GitHub](https://github.com/jowilf/starlette-admin) (👨‍💻 33 · 🔀 96 · 📦 1.1K):

	```
	git clone https://github.com/jowilf/starlette-admin
	```
- [PyPi](https://pypi.org/project/starlette-admin) (📥 210K / month · 📦 37 · ⏱️ 16.08.2026):
	```
	pip install starlette-admin
	```
- [Conda](https://anaconda.org/conda-forge/starlette-admin) (📥 20K · ⏱️ 22.07.2026):
	```
	conda install -c conda-forge starlette-admin
	```
</details>
<details><summary><b><a href="https://github.com/geex-arts/django-jet">django-jet</a></b> (🥉18 ·  ⭐ 3.6K · 💤) - Modern responsive template for the Django admin.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 770):

	```
	git clone https://github.com/geex-arts/django-jet
	```
- [PyPi](https://pypi.org/project/django-jet) (📥 16K / month · 📦 8 · ⏱️ 18.10.2018):
	```
...
- [GitHub](https://github.com/kong/kong) (👨‍💻 450 · 🔀 5.2K · 📦 25):
	...
	```
- [Docker Hub](https://hub.docker.com/r/_/kong) (📥 360M · ⭐ 830 · ⏱️ 18.08.2026):
	```
	docker pull kong
	```
</details>
...
- [GitHub](https://github.com/corydolphin/flask-cors) (👨‍💻 54 · 🔀 150 · 📦 460K):
	...
	```
- [PyPi](https://pypi.org/project/flask-cors) (📥 58M / month · 📦 1.1K · ⏱️ 08.06.2026):
	```
...
- [GitHub](https://github.com/plangrid/flask-rebar) (👨‍💻 48 · 🔀 38 · 📦 58):
	...
	```
- [PyPi](https://pypi.org/project/flask-rebar) (📥 4.1K / month · 📦 7 · ⏱️ 26.06.2026):
	```
...
- [GitHub](https://github.com/thomaxxl/safrs) (👨‍💻 17 · 🔀 73 · 📦 610):
	...
	```
- [PyPi](https://pypi.org/project/safrs) (📥 760 / month · 📦 2 · ⏱️ 09.03.2026):
	```
	pip install safrs
	```
</details>
...
- <b><a href="https://github.com/lixxu/flask-paginate">flask-paginate</a></b> (🥈24 ·  ⭐ 280 · 💀) - Pagination support for flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://flask.palletsprojects.com/en/1.1.x/_static/flask-icon.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub]() (👨‍💻 110 · 🔀 300 · 📦 1.9K):
	...
	```
- [PyPi](https://pypi.org/project/sqladmin) (📥 980K / month · 📦 51 · ⏱️ 06.08.2026):
	```
...
- [GitHub](https://github.com/stephenhillier/starlette_exporter) (👨‍💻 27 · 🔀 38):
	...
	```
- [PyPi](https://pypi.org/project/starlette_exporter) (📥 1.8M / month · 📦 41 · ⏱️ 29.07.2026):
	```
...
- [GitHub]() (👨‍💻 7 · 🔀 59 · 📦 18):
	...
	```
- [PyPi](https://pypi.org/project/fastapi-mvc) (📥 180 / month · ⏱️ 11.02.2026):
	```
...
- [GitHub](https://github.com/django-extensions/django-extensions) (👨‍💻 610 · 🔀 1.2K · 📦 270K):
	...
	```
- [PyPi](https://pypi.org/project/django-extensions) (📥 15M / month · 📦 550 · ⏱️ 11.04.2025):
	```
...
- [GitHub](https://github.com/carltongibson/django-filter) (👨‍💻 220 · 🔀 770 · 📦 200K):
	...
	```
- [PyPi](https://pypi.org/project/django-filter) (📥 18M / month · 📦 1.2K · ⏱️ 11.07.2026):
	```
...
- [GitHub](https://github.com/joke2k/django-environ) (👨‍💻 110 · 🔀 340 · 📦 280K):
	...
	```
- [PyPi](https://pypi.org/project/django-environ) (📥 8.7M / month · 📦 520 · ⏱️ 18.06.2026):
	```
...
- [PyPi](https://pypi.org/project/django-stubs) (📥 11M / month · 📦 630 · ⏱️ 12.08.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-stubs) (📥 94K · ⏱️ 13.08.2026):
	```
...
- [GitHub](https://github.com/vitalik/django-ninja) (👨‍💻 180 · 🔀 610):

	```
	git clone https://github.com/vitalik/django-ninja
	```
- [PyPi](https://pypi.org/project/django-ninja) (📥 3.4M / month · 📦 260 · ⏱️ 17.08.2026):
	```
	pip install django-ninja
	```
- [Conda](https://anaconda.org/conda-forge/django-ninja) (📥 49K · ⏱️ 18.08.2026):
	```
...
- [GitHub](https://github.com/jazzband/sorl-thumbnail) (👨‍💻 170 · 🔀 500 · 📦 16K):

	```
	git clone https://github.com/jazzband/sorl-thumbnail
	```
- [PyPi](https://pypi.org/project/sorl-thumbnail) (📥 520K / month · 📦 120 · ⏱️ 19.08.2026):
	```
...
- [GitHub]() (👨‍💻 120 · 🔀 320 · 📦 32K):
	...
	```
- [PyPi](https://pypi.org/project/django-phonenumber-field) (📥 6.9M / month · 📦 160 · ⏱️ 23.07.2026):
	```
...
- [GitHub](https://github.com/django-oscar/django-oscar) (👨‍💻 380 · 🔀 2.3K · 📦 1.2K):
	...
	```
- [PyPi](https://pypi.org/project/django-oscar) (📥 67K / month · 📦 47 · ⏱️ 05.08.2026):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 100 · 🔀 670 · 📦 20K):
	...
	```
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 340K / month · 📦 72 · ⏱️ 30.07.2026):
	```
...
- [GitHub](https://github.com/typeddjango/djangorestframework-stubs) (👨‍💻 96 · 🔀 140 · 📦 4.5K):
	...
	```
- [PyPi](https://pypi.org/project/djangorestframework-stubs) (📥 6.3M / month · 📦 120 · ⏱️ 12.08.2026):
	```
	pip install djangorestframework-stubs
	```
- [Conda](https://anaconda.org/conda-forge/djangorestframework-stubs) (📥 46K · ⏱️ 14.08.2026):
	```
...
- [GitHub](https://github.com/django/channels) (👨‍💻 280 · 🔀 820 · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 6.2M / month · 📦 440 · ⏱️ 20.11.2025):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 180 · 🔀 370 · 📦 2.7K):
	...
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 340K / month · 📦 35 · ⏱️ 13.09.2025):
	```
...
- [GitHub](https://github.com/viewflow/django-fsm) (👨‍💻 70 · 🔀 310 · 📦 1.9K):
	...
	```
- [PyPi](https://pypi.org/project/django-fsm) (📥 650K / month · 📦 64 · ⏱️ 07.10.2025):
	```
...
- [GitHub](https://github.com/bennylope/django-organizations) (👨‍💻 54 · 🔀 220 · 📦 320):
	...
	```
- [PyPi](https://pypi.org/project/django-organizations) (📥 86K / month · 📦 7 · ⏱️ 03.07.2026):
	```
...
- [GitHub](https://github.com/mozilla/django-csp) (👨‍💻 67 · 🔀 110 · 📦 5.1K):
	...
	```
- [PyPi](https://pypi.org/project/django-csp) (📥 4.3M / month · 📦 54 · ⏱️ 02.04.2025):
	```
...
- [GitHub](https://github.com/sehmaschine/django-filebrowser) (👨‍💻 38 · 🔀 410 · 📦 1K):
	...
	```
- [PyPi](https://pypi.org/project/django-filebrowser) (📥 24K / month · 📦 4 · ⏱️ 27.07.2026):
	```
	pip install django-filebrowser
	```
</details>
<details><summary><b><a href="https://github.com/noripyt/django-cachalot">django-cachalot</a></b> (🥉23 ·  ⭐ 1.4K) - No effort, no worry, maximum performance. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/noripyt/django-cachalot) (👨‍💻 40 · 🔀 160):
...
- [GitHub](https://github.com/jazzband/django-configurations) (👨‍💻 74 · 🔀 140 · 📦 3.4K):
	...
	```
- [PyPi](https://pypi.org/project/django-configurations) (📥 360K / month · 📦 69 · ⏱️ 27.03.2024):
	```
...
- [GitHub](https://github.com/cookiecutter/cookiecutter-django) (👨‍💻 480 · 🔀 3K · 📦 34):
	...
	```
- [PyPi](https://pypi.org/project/cookiecutter-django) (📥 57 / month · ⏱️ 15.01.2018):
	```
...
- [GitHub](https://github.com/browniebroke/django-codemod) (👨‍💻 30 · 🔀 19 · 📦 5):
	...
	```
- [PyPi](https://pypi.org/project/django-codemod) (📥 3K / month · ⏱️ 07.08.2026):
	```
...
- <b><a href="https://github.com/django-cache-machine/django-cache-machine">django-cache-machine</a></b> (🥉20 ·  ⭐ 880 · 💀) - Automatic caching and invalidation for Django models.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://static.djangoproject.com/img/icon-touch.e4872c4da341.png" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 340 · 🔀 1.7K · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/jinja2) (📥 760M / month · 📦 24K · ⏱️ 05.03.2025):
	```
	pip install jinja2
	```
...
- [PyPi](https://pypi.org/project/dnspython) (📥 340M / month · 📦 2.5K · ⏱️ 07.09.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dnspython) (📥 8.3M · ⏱️ 08.09.2025):
	```
...
- [GitHub](https://github.com/pyca/pyopenssl) (👨‍💻 120 · 🔀 440 · 📦 280K):
...
- [GitHub](https://github.com/kjd/idna) (👨‍💻 46 · 🔀 130 · 📦 2.5M):

	```
	git clone https://github.com/kjd/idna
	```
- [PyPi](https://pypi.org/project/idna) (📥 1.9B / month · 📦 11K · ⏱️ 18.08.2026):
	```
	pip install idna
	```
- [Conda](https://anaconda.org/conda-forge/idna) (📥 94M · ⏱️ 18.08.2026):
	```
...
- [GitHub](https://github.com/certifi/python-certifi) (👨‍💻 41 · 🔀 300 · 📦 5):
	...
	```
- [PyPi](https://pypi.org/project/certifi) (📥 2B / month · 📦 16K · ⏱️ 22.07.2026):
	```
	pip install certifi
	```
...
- [GitHub](https://github.com/sqlalchemy/mako) (👨‍💻 63 · 🔀 83 · 📦 340K):
	...
	```
- [PyPi](https://pypi.org/project/mako) (📥 220M / month · 📦 1.4K · ⏱️ 05.08.2026):
	```
	pip install mako
	```
...
- [GitHub](https://github.com/postmanlabs/httpbin) (👨‍💻 110 · 🔀 1.9K · 📦 1.8K):
	...
	```
- [PyPi](https://pypi.org/project/httpbin) (📥 470K / month · 📦 31 · ⏱️ 16.06.2026):
	```
	pip install httpbin
	```
</details>
...
- [GitHub](https://github.com/cgohlke/tifffile) (👨‍💻 1 · 🔀 160 · 📦 89K):
	...
	```
- [PyPi](https://pypi.org/project/tifffile) (📥 30M / month · 📦 2.6K · ⏱️ 15.08.2026):
	```
	pip install tifffile
	```
- [Conda](https://anaconda.org/conda-forge/tifffile) (📥 10M · ⏱️ 01.08.2026):
	```
...
- [GitHub]() (👨‍💻 330 · 🔀 3.9K · 📦 6.7K):
	...
	```
- [PyPi](https://pypi.org/project/impacket) (📥 760K / month · 📦 180 · ⏱️ 19.05.2026):
	```
...
- [GitHub](https://github.com/r0x0r/pywebview) (👨‍💻 190 · 🔀 630 · 📦 5K):

	```
	git clone https://github.com/r0x0r/pywebview
	```
- [PyPi](https://pypi.org/project/pywebview) (📥 2.3M / month · 📦 490 · ⏱️ 15.04.2026):
	```
...
- [GitHub]() (👨‍💻 310 · 🔀 1.7K):
	...
	```
- [PyPi](https://pypi.org/project/web3) (📥 6.9M / month · 📦 2.2K · ⏱️ 01.05.2026):
	```
	pip install web3
	```
...
- [GitHub](https://github.com/aiortc/aiortc) (👨‍💻 41 · 🔀 880 · 📦 6.9K):
	...
	```
- [PyPi](https://pypi.org/project/aiortc) (📥 2.2M / month · 📦 330 · ⏱️ 13.07.2026):
	```
	pip install aiortc
	```
</details>
...
- [GitHub](https://github.com/WeblateOrg/weblate) (👨‍💻 2.2K · 🔀 1.3K · 📦 54):
	...
	```
- [PyPi](https://pypi.org/project/weblate) (📥 180K / month · ⏱️ 07.08.2026):
	```
	pip install weblate
	```
</details>
...
- [PyPi](https://pypi.org/project/webassets) (📥 290K / month · 📦 98 · ⏱️ 17.08.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/webassets) (📥 85K · ⏱️ 03.07.2026):
	```
...
- [GitHub](https://github.com/alexdlaird/pyngrok) (👨‍💻 34 · 🔀 59 · 📦 12K):

	```
	git clone https://github.com/alexdlaird/pyngrok
	```
- [PyPi](https://pypi.org/project/pyngrok) (📥 1.6M / month · 📦 340 · ⏱️ 29.04.2026):
	```
	pip install pyngrok
	```
- [Conda](https://anaconda.org/conda-forge/pyngrok) (📥 270K · ⏱️ 29.04.2026):
	```
...
- [PyPi](https://pypi.org/project/fake-useragent) (📥 11M / month · 📦 1.2K · ⏱️ 14.04.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fake-useragent) (📥 95K · ⏱️ 27.08.2025):
	```
	conda install -c conda-forge fake-useragent
	```
</details>
<details><summary><b><a href="https://github.com/Kozea/Radicale">Radicale</a></b> (🥉25 ·  ⭐ 3.9K) - A simple CalDAV (calendar) and CardDAV (contact) server. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/Kozea/Radicale) (👨‍💻 170 · 🔀 480 · 📦 200):
	...
	```
- [PyPi](https://pypi.org/project/radicale) (📥 63K / month · 📦 43 · ⏱️ 06.08.2026):
	```
...
- [GitHub](https://github.com/shon/httpagentparser) (👨‍💻 37 · 🔀 57 · 📦 6.3K):
	...
	```
- [PyPi](https://pypi.org/project/httpagentparser) (📥 580K / month · 📦 51 · ⏱️ 08.03.2026):
	```
...
- [PyPi](https://pypi.org/project/trustme) (📥 1.1M / month · 📦 52 · ⏱️ 02.01.2025):
	...
	pip install trustme
	```
- [Conda](https://anaconda.org/conda-forge/trustme) (📥 43K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/nabla-c0d3/sslyze) (👨‍💻 81 · 🔀 490):
	...
	```
- [PyPi](https://pypi.org/project/sslyze) (📥 160K / month · 📦 16 · ⏱️ 29.03.2026):
	```
	pip install sslyze
	```
</details>
...
- [GitHub](https://github.com/pyload/pyload) (👨‍💻 250 · 🔀 750 · 📦 24):
	...
	```
- [PyPi](https://pypi.org/project/pyload-ng) (📥 6.9K / month · 📦 3 · ⏱️ 09.07.2026):
	```
...
- [GitHub]() (👨‍💻 12 · 🔀 240 · 📦 21):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 110 / month · ⏱️ 22.05.2026):
	```
	pip install toapi
	```
</details>
